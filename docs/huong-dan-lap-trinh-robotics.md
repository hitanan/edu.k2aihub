...
- **Các bộ phận cần thiết:**
    ...
    3. Mạch điều khiển động cơ (Motor Driver Shield, ví dụ: L293D hoặc L298N). *Lý do: Các chân của Arduino không cung cấp đủ dòng điện để chạy động cơ trực tiếp, bạn cần một mạch công suất riêng.*
