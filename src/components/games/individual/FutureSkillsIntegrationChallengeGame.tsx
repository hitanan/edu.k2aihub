...
const scenarios: SkillScenario[] = [
  {
    ...
    scenario:
      'Bạn làm việc trong team marketing và cần tạo campaign cho sản phẩm mới. Team có AI tools nhưng thiếu ý tưởng sáng tạo.',
  ...
  },
  {
    ...
    scenario:
      'Bạn lead một team remote có members ở nhiều quốc gia khác nhau. Dự án gặp khó khăn về timeline và communication.',
    ...
    solutions: [
      ...
      {
        option:
          'Thiết lập clear communication protocol, respect cultural differences, và dùng collaboration tools hiệu quả',
        points: 35,
  ...
  },
  {
    ...
    scenario:
      'Company bạn muốn chuyển đổi xanh nhưng lo về cost và productivity. Bạn được assign lead green innovation project.',
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="text-center">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-purple-200">
            ...
            <div className="text-lg text-gray-600 mb-4">Đã tích hợp {skillsEarned.size} kỹ năng tương lai</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">
              Scenario {currentScenario + 1}/{scenarios.length} • {totalScore} điểm • ⏰ {Math.floor(timeLeft / 60)}:
            ...
            {(currentScenarioData.solutions.find((s) => s.option === selectedSolution)?.skills.length || 0) > 0 && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {currentScenarioData.solutions
                    .find((s) => s.option === selectedSolution)
                    ?.skills.map((skill) => (
