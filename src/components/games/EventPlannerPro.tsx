...
export default function EventPlannerPro() {
  const gameData = EDUCATIONAL_GAMES_DATA.find((game) => game.id === 'event-planner-pro');
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-900/20 to-pink-900/20">
        <div className="text-center">
          ...
          <p className="text-gray-300">The Event Planner Pro game could not be loaded.</p>
        </div>
      </div>
    );
  }
