...
function HeritageSite({ site, isSelected, onSelect, onQuizStart }: {
...
function QuizModal({ site, onAnswer, onClose }: {
...
function GameStats({ visited, score, totalSites }: {
  visited: number;
  score: number;
  totalSites: number;
}) {
    ...
    <div className="absolute top-4 left-4 bg-white bg-opacity-90 rounded-lg p-4 min-w-[250px]">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold">{visited}/{totalSites}</span>
        </div>
      ...
      <div className="bg-white rounded-xl p-8 max-w-2xl mx-4 text-center">
        ...
        <div className="text-left space-y-4 mb-6">
          <p className="text-gray-600">
            Chào mừng đến với hành trình khám phá di sản văn hóa Việt Nam! 
            Bạn sẽ tham quan các địa danh lịch sử nổi tiếng nhất của đất nước.
          </p>
          
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-bold text-blue-800 mb-2">🎮 Cách chơi:</h3>
            <ul className="text-blue-700 space-y-1 text-sm">
              <li>• <strong>Click vào các di tích</strong> để khám phá</li>
              <li>• <strong>Trả lời câu hỏi</strong> về từng di sản</li>
              <li>• <strong>Thu thập điểm</strong> và tìm hiểu lịch sử</li>
              <li>• <strong>Kéo chuột</strong> để xoay góc nhìn</li>
              <li>• <strong>Lăn chuột</strong> để zoom in/out</li>
            </ul>
          </div>
