...
const Vehicle3D: React.FC<{
  ...
  onPositionUpdate: (vehicleId: string, newPosition: [number, number, number]) => void;
}> = ({ vehicle, onSelect, onPositionUpdate }) => {
  const meshRef = useRef<THREE.Group>(null);
  const [currentPosition, setCurrentPosition] = useState<[number, number, number]>(vehicle.position);
        ...
        <div className="absolute inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="max-w-4xl mx-auto p-8 bg-black/60 backdrop-blur rounded-2xl border border-blue-500/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-green-400 mb-3">🎮 Cách Practice</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
            ...
            <div className="border-t border-gray-600 pt-6">
              <h3 className="text-xl font-bold text-center mb-4 text-orange-400">💡 Mẹo Practice Hiệu Quả</h3>
