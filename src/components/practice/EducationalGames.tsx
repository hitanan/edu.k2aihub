...
// Truncate long description text for cards (preserve words, add ellipsis)
const truncateText = (text: string | undefined, maxChars = 220) => {
  if (!text) return '';
  // Normalize whitespace (newlines -> spaces) and trim
