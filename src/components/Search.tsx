  ...
  useEffect(() => {
    ...
    const filtered = cities.filter(city => {
      ...
      return (
        ...
        city.oldNames.some(oldName => oldName.toLowerCase().includes(searchLower)) ||
  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search cities, regions, or former names..."
          value={searchTerm}
        ...
        <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto">
          {filteredCities.length > 0 ? (
                      ...
                      <div className="text-sm text-gray-600 mt-1">
                        ...
                        {city.oldNames.length > 1 && (
                          <span className="ml-2 text-gray-400">
                            • Includes: {city.oldNames.slice(1).join(', ')}
                          </span>
                        )}
                      </div>
                    </div>
            ...
            <div className="px-4 py-8 text-center text-gray-500">
              ...
              <p className="text-sm mt-1">Try searching for city names, regions, or former province names</p>
            </div>
          )}
        </div>
      )}
