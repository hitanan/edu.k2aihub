...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Khám phá sứ mệnh, phương pháp và cách tiếp cận độc đáo của K2AI trong việc cung cấp giáo dục chất lượng cao với công nghệ AI tiên tiến.',
    type: 'website',
  },
};
...
const AboutPage = () => {
  const stats = [
    { label: 'Modules Giáo Dục', value: '14+', icon: <BookOpen className="w-6 h-6" /> },
    { label: 'Chủ Đề Học Tập', value: '100+', icon: <Brain className="w-6 h-6" /> },
    { label: 'Dự Án Thực Tế', value: '500+', icon: <Target className="w-6 h-6" /> },
    { label: 'Học Viên Mục Tiêu', value: '1M+', icon: <Users className="w-6 h-6" /> }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Về <span className="bg-gradient-to-r from-yellow-400 to-pink-400 bg-clip-text text-transparent">K2AI</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto">
              Tạo ra một thế giới mà mọi người đều có thể tiếp cận giáo dục chất lượng cao, 
              phù hợp với nhu cầu cá nhân và xu hướng công nghệ mới nhất.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Hệ thống giáo dục truyền thống chưa theo kịp tốc độ phát triển của công nghệ và nhu cầu thị trường.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Nhiều người không có điều kiện tiếp cận giáo dục chất lượng cao do rào cản về địa lý, thời gian và chi phí.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mỗi người có cách học, mức độ và mục tiêu khác nhau, cần giải pháp giáo dục linh hoạt và thích ứng.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, index) => (
              <div key={index} className="text-center group hover:transform hover:scale-105 transition-all duration-300">
                <div className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${value.color} rounded-3xl text-white mb-6 group-hover:shadow-2xl transition-shadow duration-300`}>
                  {value.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {methodology.map((step, index) => (
              <div key={index} className={`flex items-center ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12`}>
