...
export default function HomePage() {
  ...
  const featuredModules = [
    {
      ...
      subtitle: 'Essential Skills 2025',
      description: 'Phát triển kỹ năng tư duy logic và giải quyết vấn đề sáng tạo cần thiết cho thế hệ Gen Z',
    ...
    },
    {
      ...
      subtitle: 'Essential Skills 2025',
      description: 'Master kỹ năng giao tiếp và presentation trong thời đại số - từ cơ bản đến đa văn hóa',
  ...
  const learningPaths = [
    ...
    },
    {
      ...
      modules: ['🧠 Critical Thinking', '🗣️ Communication', '📱 Digital Marketing', '💰 Tài chính', '🎮 Game Dev'],
