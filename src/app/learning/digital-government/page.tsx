...
export async function generateMetadata() {
  return {
    title: createTitle('Digital Government & Civic Technology - Chính phủ Điện tử và Công nghệ Công dân'),
    description: createDescription('Khóa học chính phủ điện tử và công nghệ công dân: smart city, e-governance, IoT monitoring và civic engagement platforms. Xây dựng dịch vụ công kỹ thuật số.'),
    keywords: ['chính phủ điện tử', 'smart city vietnam', 'e governance', 'civic technology', 'dịch vụ công trực tuyến', 'công nghệ công dân', 'K2AiHub'],
    openGraph: {
      title: 'Digital Government & Civic Technology - K2AiHub',
      description: 'Học phát triển công nghệ phục vụ chính phủ điện tử và smart city',
      type: 'website',
    },
  };
}
...
export default function DigitalGovernmentPage() {
  const moduleData = {
    ...
    description: 'Khóa học chuyên sâu về phát triển công nghệ phục vụ chính phủ điện tử và smart city. Học xây dựng dịch vụ công trực tuyến, IoT monitoring systems và civic engagement platforms cho Vietnamese government context.',
    level: 'Nâng cao',
    duration: '18-22 giờ',
