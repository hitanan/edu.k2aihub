...
export async function generateMetadata() {
  return {
    ...
    description: createDescription('Học cách số hóa và bảo tồn di sản văn hóa Việt Nam. Phát triển tourism technology và cultural experience platforms cho thị trường Việt Nam.'),
    keywords: ['văn hóa việt nam', 'di sản số', 'tourism technology', 'cultural preservation', 'digital heritage', 'vietnamese culture', 'k2aihub'],
    openGraph: {
      title: 'Văn Hóa Việt Nam & Di Sản Số | K2AiHub',
      description: 'Khóa học toàn diện về digital heritage preservation và tourism technology cho thị trường Việt Nam',
      type: 'website',
    },
  };
}
...
export default function VietnameseCulturePage() {
  const moduleData = {
    ...
    description: 'Học cách số hóa và bảo tồn di sản văn hóa Việt Nam bằng công nghệ hiện đại. Phát triển tourism technology platforms và cultural experience solutions cho thị trường 95 triệu người Việt Nam và 18 triệu du khách quốc tế hàng năm.',
    level: 'Trung bình',
    duration: '8-12 giờ',
