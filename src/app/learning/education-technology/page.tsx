...
export async function generateMetadata() {
  return {
    title: createTitle('Công Nghệ Giáo Dục - Education Technology'),
    description: createDescription('Master công nghệ giáo dục hiện đại với LMS, AI, VR/AR, Learning Analytics và EdTech Entrepreneurship. Khóa học toàn diện về digital transformation trong giáo dục và đổi mới sáng tạo EdTech.'),
    keywords: [
      'công nghệ giáo dục',
    ...
    openGraph: {
      title: 'Công Nghệ Giáo Dục - Education Technology | K2AI',
      description: 'Master công nghệ giáo dục hiện đại với LMS, AI, VR/AR, Learning Analytics và EdTech Entrepreneurship tại K2AI',
      type: 'website',
    },
  };
}
