...
export const metadata: Metadata = createModuleMetadata(
  ...
  ['công nghệ giáo dục', 'education technology', 'edtech', 'lms', 'learning management system', 'ai giáo dục', 'vr ar giáo dục', 'learning analytics', 'edtech startup', 'digital education', 'K2AI'],
