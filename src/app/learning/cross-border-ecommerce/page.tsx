...
export default function CrossBorderEcommerceMainPage() {
  const moduleData = {
    ...
    description:
      'Nắm vững nghệ thuật kinh doanh online quốc tế với market size lên đến $12 tỷ USD. Từ việc thiết lập store trên các platform lớn như Amazon, eBay đến quản lý logistics, thanh toán và marketing đa văn hóa. Khóa học cung cấp kiến thức thực tế để mở rộng thành công ra thị trường ASEAN và toàn cầu.',
    level: 'Trung bình',
    duration: '12-15 giờ',
  ...
  return <ModulePageTemplate moduleData={moduleData} lessons={crossBorderEcommerceLessons} />;
}
