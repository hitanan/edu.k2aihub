...
export default function CrossPlatformStrategyPage() {
  const moduleData = {
    ...
    description: 'Tối ưu hóa thương hiệu và marketing trên tất cả các nền tảng số. Học cách xây dựng chiến lược đa nền tảng hiệu quả, duy trì tính nhất quán thương hiệu và tối đa hóa ROI marketing.',
    level: 'Nâng cao',
    duration: '12-15 giờ',
