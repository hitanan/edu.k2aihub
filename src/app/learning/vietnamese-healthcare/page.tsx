...
export async function generateMetadata() {
  return {
    ...
    description: createDescription(
      'Phát triển giải pháp công nghệ y tế cho thị trường Việt Nam. Học digital health, AI medical imaging và telemedicine platforms.',
    ),
    keywords: [
      'công nghệ y tế',
    ...
    siteName: 'K2AiHub - Nền tảng học tập thông minh',
      ...
      description:
        'Khóa học toàn diện về healthcare technology và digital health solutions cho thị trường Việt Nam',
      type: 'website',
    },
  twitter: {
