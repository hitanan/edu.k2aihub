...
export default function DigitalArtsCreativeTechMainPage() {
  const moduleData = {
    ...
    description: 'Master digital art, motion graphics, AI art generation và immersive media cho creative careers. Học cách kết hợp traditional art skills với cutting-edge technology để tạo ra innovative content.',
    level: 'Trung bình',
    duration: '10-12 giờ',
