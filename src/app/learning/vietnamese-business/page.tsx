...
function convertVietnameseBusinessToBase(lesson: VietnameseBusinessLesson): BaseLessonData {
  return {
    id: lesson.id,
    title: lesson.title,
...
export async function generateMetadata() {
  return {
    title: createTitle('Vietnamese Business & Entrepreneurship - Kinh doanh và Khởi nghiệp Việt Nam'),
    description: createDescription('Khóa học kinh doanh và khởi nghiệp tại Việt Nam: startup ecosystem, quy định pháp lý, FinTech và e-commerce strategies. Thành công trong thị trường Việt Nam.'),
    keywords: ['kinh doanh việt nam', 'startup vietnam', 'fintech vietnam', 'e-commerce vietnam', 'doanh nghiệp việt nam', 'đầu tư việt nam', 'K2AiHub'],
    openGraph: {
      title: 'Vietnamese Business & Entrepreneurship - K2AiHub',
      description: 'Học cách thành công trong kinh doanh và khởi nghiệp tại thị trường Việt Nam',
      type: 'website',
    },
  };
}
...
export default function VietnameseBusinessPage() {
  const moduleData = {
    ...
    description: 'Khóa học toàn diện về kinh doanh và khởi nghiệp trong thị trường Việt Nam. Học navigation quy định pháp lý, startup ecosystem, FinTech development và e-commerce strategies được tối ưu cho văn hóa và consumer behavior Việt Nam.',
    level: 'Trung bình',
    duration: '16-20 giờ',
  ...
  const convertedLessons = vietnameseBusinessLessons.map(convertVietnameseBusinessToBase);
