...
export const metadata: Metadata = {
  title: createTitle("Robot Di Động - Robotics"),
  description: createDescription("Học cách thiết kế và điều khiển robot di động"),
  keywords: createKeywords(["mobile robot", "robot navigation", "wheel control", "autonomous robot"]),
  authors: [{ name: "K2AiHub Team" }],
  openGraph: {
    title: createTitle("Robot Di Động"),
    description: createDescription("Thiết kế robot di động thông minh"),
    type: "website",
  },
};

export default function MobileRobotsLesson() {
  const lesson = roboticsLessons.find(l => l.id === 'mobile-robots');
  const navigation = getModuleNavigation('robotics', 'mobile-robots');
