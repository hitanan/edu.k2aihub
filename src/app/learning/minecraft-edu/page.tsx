...
export async function generateMetadata() {
  return {
    title: createTitle('Học tập Sáng tạo với Minecraft Education'),
    description: createDescription(
      'Khám phá tiềm năng vô hạn của Minecraft Education. Học lập trình, hóa học, và nhiều hơn nữa trong một thế giới mở đầy sáng tạo.',
    ),
    keywords: ['minecraft', 'minecraft education', 'lập trình khối', 'hóa học', 'stem', 'K2AI'],
    openGraph: {
      title: 'Học tập Sáng tạo với Minecraft Education - K2AiHub',
      description: 'Khám phá tiềm năng vô hạn của Minecraft Education. Học lập trình, hóa học, và nhiều hơn nữa.',
      type: 'website',
    },
  };
}
...
export default function MinecraftEduPage() {
  const moduleData = {
    ...
    additionalStats: [
      {
        label: 'Nền tảng',
        value: 'Minecraft: Education Edition',
        icon: <Box className="w-6 h-6" />,
      },
    ],
  };

  return <ModulePageTemplate moduleData={moduleData} lessons={minecraftLessons} />;
}
