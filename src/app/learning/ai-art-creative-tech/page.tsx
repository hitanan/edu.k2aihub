...
export const metadata: Metadata = {
  ...
  description: createDescription("Khóa học AI Art và Creative Technology. Học Midjourney, DALL-E, Stable Diffusion, AI video generation và creative workflows"),
  keywords: createKeywords(["ai art", "midjourney", "dall-e", "stable diffusion", "ai video", "creative technology", "digital art", "prompt engineering"]),
  authors: [{ name: "K2AiHub Team" }],
  openGraph: {
    title: createTitle("AI Art & Creative Technology - K2AiHub"),
    description: createDescription("Master AI art generation và creative technology với các công cụ hàng đầu"),
    type: "website",
  },
};
...
function convertToLesson(aiLesson: AiArtLesson): BaseLessonData {
  return {
    ...
    caseStudies: aiLesson.caseStudies?.map(cs => ({
      title: cs.title,
...
export default function AiArtCreativeTechPage() {
  ...
  const moduleConfig: ModuleData = {
    ...
    description: 'Master AI art generation và creative technology. Từ Midjourney, DALL-E đến AI video production - tạo ra những tác phẩm nghệ thuật đỉnh cao với sức mạnh của AI.',
    primaryColor: 'pink',
    ...
    technicalHighlights: [
      {
        ...
        icon: '🎨',
        items: ['Midjourney Mastery', 'DALL-E 3 Techniques', 'Stable Diffusion', 'Prompt Engineering']
      },
      {
      ...
      },
      {
        ...
        icon: '⚡',
        items: ['Adobe Integration', 'Brand Design Systems', 'Creative Automation', 'Style Transfer']
      },
      {
        title: 'Professional Applications',
        icon: '💼',
        items: ['Marketing Campaigns', 'Brand Identity', 'Social Media Content', 'Product Visualization']
      },
      {
        title: 'Advanced Techniques',
        icon: '🚀',
        items: ['Style Consistency', 'Multi-Platform Optimization', 'Creative Direction', 'Quality Control']
      },
      {
