...
export const metadata: Metadata = createModuleMetadata(
  'Công Nghệ Vũ Trụ',
  'Tìm hiểu về space technology, satellite systems và cơ hội cho Việt Nam trong kỷ nguyên khám phá không gian. Học về CubeSat, space missions và space entrepreneurship.',
...
export default function SpaceTechnologyMainPage() {
  ...
  return <ModulePageTemplate moduleData={moduleData} lessons={spaceTechnologyLessons} />;
}
