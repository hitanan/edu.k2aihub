...
export async function generateMetadata() {
  return {
    ...
    description: createDescription('Khóa học Data Science chuyên sâu từ cơ bản đến nâng cao. Học Machine Learning, Big Data Analytics, Data Visualization và ứng dụng thực tế trong doanh nghiệp.'),
    keywords: ['data science', 'khoa học dữ liệu', 'machine learning', 'big data', 'data analytics', 'python', 'AI', 'K2AI'],
    openGraph: {
      title: 'Data Science - Khoa học dữ liệu toàn diện | K2AiHub',
      description: 'Khóa học Data Science chuyên sâu từ cơ bản đến nâng cao với Machine Learning, Big Data và ứng dụng thực tế.',
      type: 'website',
    },
  };
}
...
export default function DataScienceMainPage() {
  const moduleData = {
    ...
    description: 'Khóa học Data Science toàn diện giúp bạn thành thạo quy trình CRISP-DM, Machine Learning algorithms, Big Data processing và Data Storytelling. Phát triển kỹ năng phân tích dữ liệu chuyên nghiệp cho thời đại số.',
    level: 'Trung bình',
    duration: '25-30 giờ',
  ...
  return (
    <ModulePageTemplate
      ...
      heroImageUrl="/images/data-science-hero.jpg"
    />
  );
}
