...
export async function generateMetadata() {
  return {
    ...
    description: createDescription('Khám phá thế giới công nghệ nano với các ứng dụng tiên tiến trong y học, điện tử, môi trường và năng lượng. Học cách tổng hợp vật liệu nano, phát triển thiết bị quantum và tạo ra các giải pháp bền vững cho tương lai.'),
    keywords: ['công nghệ nano', 'vật liệu tiên tiến', 'nanomedicine', 'quantum devices', 'nanotechnology vietnam', 'K2AI'],
    openGraph: {
      title: 'Công Nghệ Nano & Vật Liệu Tiên Tiến | K2AiHub',
      description: 'Chương trình học công nghệ nano toàn diện với ứng dụng thực tế trong y học, điện tử và môi trường',
      type: 'website',
    },
  };
}
...
export default function NanotechnologyPage() {
  const moduleData = {
    ...
    description: 'Chương trình học toàn diện về công nghệ nano, từ tổng hợp vật liệu nano đến phát triển thiết bị quantum và ứng dụng y sinh. Khám phá cách công nghệ nano đang thay đổi y học, điện tử, môi trường và năng lượng tại Việt Nam.',
    level: 'Nâng cao',
    duration: '25-30 giờ',
