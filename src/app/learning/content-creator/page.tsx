...
import { contentCreatorLessons } from '@/data/modules/content-creator';
...
export default function ContentCreatorPage() {
  const moduleData = {
    ...
    description:
      'Khóa học toàn diện từ A-Z để trở thành content creator thành công trên các nền tảng TikTok, YouTube, Instagram, Facebook. Học cách xây dựng personal brand mạnh mẽ, tạo nội dung viral, và kiếm tiền bền vững từ sự sáng tạo của bạn.',
