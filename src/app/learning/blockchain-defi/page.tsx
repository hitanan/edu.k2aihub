...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Blockchain & DeFi Technology - Công Nghệ Blockchain',
    description:
    ...
    keywords:
      'blockchain, defi, smart contracts, cryptocurrency, nft, solidity, web3, fintech, vietnam blockchain, digital currency, K2AI',
  };
}
...
export default function BlockchainPage() {
  ...
  return <ModulePageTemplate lessons={blockchainLessons.map(convertToBaseLessonData)} moduleData={moduleData} />;
}
