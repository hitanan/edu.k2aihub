...
export default function BiotechnologyPage() {
  ...
  const moduleData: ModuleData = {
    ...
    description:
      'Khám phá thế giới công nghệ sinh học hiện đại. Từ gene editing với CRISPR đến phát triển thuốc, học cách ứng dụng sinh học để giải quyết các thách thức y tế và môi trường.',
