...
export default async function YoungEntrepreneurLessonPage({ params }: PageProps) {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-500/10 p-4 rounded-lg border border-blue-500/20">
          ...
          <div className="text-gray-300 text-sm space-y-2">
            <a href="https://startup.gov.vn" target="_blank" rel="noopener noreferrer" 
               className="block text-blue-400 hover:text-blue-300 transition-colors">
              Vietnam National Innovation Center
            </a>
            <a href="https://techfest.vn" target="_blank" rel="noopener noreferrer"
               className="block text-blue-400 hover:text-blue-300 transition-colors">
              Techfest Vietnam
            </a>
            <a href="https://500.co/vietnam" target="_blank" rel="noopener noreferrer"
               className="block text-blue-400 hover:text-blue-300 transition-colors">
              500 Global Vietnam
            </a>
          </div>
