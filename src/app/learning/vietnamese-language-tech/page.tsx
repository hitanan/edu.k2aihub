...
function convertVietnameseLangTechToBase(lesson: VietnameseLangTechLesson): BaseLessonData {
  return {
    id: lesson.id,
    title: lesson.title,
...
export async function generateMetadata() {
  return {
    title: createTitle('Vietnamese Language Technology - Công nghệ Ngôn ngữ Tiếng Việt'),
    description: createDescription('Khóa học công nghệ ngôn ngữ tiếng Việt: NLP, AI chatbot, voice technology và speech recognition. Phát triển ứng dụng AI hiểu tiếng Việt tự nhiên.'),
    keywords: ['vietnamese nlp', 'tiếng việt ai', 'chatbot tiếng việt', 'voice ai vietnam', 'vietnamese speech recognition', 'phobert', 'K2AiHub'],
    openGraph: {
      title: 'Vietnamese Language Technology - K2AiHub',
      description: 'Học phát triển công nghệ AI hiểu và xử lý tiếng Việt tự nhiên',
      type: 'website',
    },
  };
}
...
export default function VietnameseLanguageTechPage() {
  const moduleData = {
    ...
    description: 'Khóa học chuyên sâu về công nghệ xử lý ngôn ngữ tự nhiên tiếng Việt. Học phát triển chatbot AI, voice assistant và NLP applications hiểu tiếng Việt với độ chính xác cao, tối ưu cho thị trường Việt Nam.',
    level: 'Trung bình',
    duration: '15-18 giờ',
  ...
  const convertedLessons = vietnameseLangTechLessons.map(convertVietnameseLangTechToBase);
