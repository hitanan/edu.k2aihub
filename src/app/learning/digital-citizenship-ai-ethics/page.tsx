...
export default function DigitalCitizenshipMainPage() {
  const moduleData = {
    ...
    description: 'Trong thời đại số hóa, việc trở thành công dân số có trách nhiệm là kỹ năng thiết yếu. Module này giúp bạn hiểu sâu về quyền và nghĩa vụ trong không gian số, đạo đức AI, bảo vệ quyền riêng tư và sử dụng công nghệ một cách có ý thức.',
    level: 'Trung bình',
    duration: '5-6 giờ',
    ...
    prerequisites: [
      'Có sử dụng internet và mạng xã hội cơ bản',
      'Quan tâm đến vấn đề đạo đức công nghệ'
    ],
    careerOutcomes: [
