...
export default function CommunicationSkillsMainPage() {
  const moduleData: ModuleData = {
    ...
    description: 'Khóa học comprehensive về kỹ năng giao tiếp và thuyết trình, từ những nguyên tắc cơ bản của active listening đến digital presentation mastery và cross-cultural communication. Được thiết kế đặc biệt cho học sinh Việt Nam với context và case studies phù hợp.',
    level: 'Trung bình',
    duration: '9-11 giờ',
