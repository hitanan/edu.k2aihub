...
export async function generateMetadata() {
  return {
    title: createTitle('Teen Wellness & Mental Health - Sức khỏe tinh thần tuổi teen'),
    description: createDescription('Chương trình toàn diện về sức khỏe tinh thần cho teenagers. Học cách quản lý stress, anxiety, xây dựng mối quan hệ tích cực và phát triển emotional intelligence cho thế hệ trẻ Việt Nam.'),
    ...
    openGraph: {
      ...
      description: 'Chương trình toàn diện về sức khỏe tinh thần cho teenagers. Quản lý stress, anxiety và phát triển emotional intelligence.',
      type: 'website',
      locale: 'vi_VN',
    },
    twitter: {
      ...
      description: 'Học cách quản lý stress, anxiety và xây dựng mối quan hệ tích cực cho thế hệ trẻ Việt Nam.',
    },
    alternates: {
