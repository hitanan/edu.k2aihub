...
export default function AdvancedCreativeSkillsMainPage() {
  const moduleData: ModuleData = {
    ...
    description: 'Nâng cao khả năng sáng tạo chuyên nghiệp trong các lĩnh vực then chốt: graphic design, video production, audio creation, content writing và photography. Học cách xây dựng portfolio mạnh mẽ, phát triển business model bền vững và thành công trong creative industry Việt Nam.',
    level: 'Nâng cao',
    duration: '25-30 giờ',
