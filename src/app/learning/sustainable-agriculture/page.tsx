...
export async function generateMetadata() {
  const title = createTitle('Nông nghiệp Bền vững và AgriTech');
  const description = createDescription(
    'Khám phá tương lai của ngành nông nghiệp với các giải pháp công nghệ cao, từ IoT, drone đến canh tác hữu cơ và kinh tế tuần hoàn.',
  );
...
export default function SustainableAgriculturePage() {
  ...
  return <ModulePageTemplate moduleData={moduleData} lessons={sustainableAgricultureLessons} />;
}
