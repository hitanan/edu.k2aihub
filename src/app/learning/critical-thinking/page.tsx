...
export default function CriticalThinkingMainPage() {
  const moduleData: ModuleData = {
    ...
    description:
      'Khóa học toàn diện về tư duy phê phán và giải quyết vấn đề sáng tạo, được thiết kế đặc biệt cho học sinh phổ thông Việt Nam. Học cách phân tích thông tin, đưa ra quyết định có căn cứ, và áp dụng Design Thinking để tạo ra những giải pháp innovative cho các vấn đề thực tế.',
    level: 'Trung bình',
    duration: '8-10 giờ',
