...
export const youngEntrepreneurLessons: YoungEntrepreneurLessonData[] = [
  {
    ...
    duration: '180 phút',
    difficulty: 'Cơ bản',
    videoUrl: 'https://www.youtube.com/watch?v=x2JRtPxGF7Y',
  ...
  },
  {
    ...
    duration: '210 phút',
    difficulty: 'Trung bình',
    videoUrl: 'https://www.youtube.com/watch?v=nkrJgHptrY8',
  ...
  },
  {
    ...
    duration: '195 phút',
    difficulty: 'Trung bình',
    videoUrl: 'https://www.youtube.com/watch?v=2DQ5bq7if-Y',
