...
export const semiconductorLessons: SemiconductorLesson[] = [
  {
    ...
    description: 'Khám phá thế giới vi mô của bán dẫn - từ silicon crystal đến transistor. Hiểu cách electron di chuyển và tạo nên các chip computer hiện đại.',
    duration: '180 phút',
    difficulty: 'Cơ bản',
    ...
    exercises: [
      {
        ...
        description: 'Sử dụng phần mềm mô phỏng để quan sát cấu trúc silicon crystal và hiểu cách electron di chuyển trong mạng tinh thể.',
        difficulty: 'Cơ bản',
        ...
        solution: 'Học viên sẽ hiểu được silicon có 4 electron valence, tạo covalent bonds với 4 atom lân cận.',
        expectedOutput: 'Hiểu được cấu trúc kim cương của silicon và electron behavior'
      },
      {
        title: 'Thí nghiệm Doping Process',
        description: 'Mô phỏng quá trình doping silicon với boron (p-type) và phosphorus (n-type) để tạo ra các vùng dẫn điện khác nhau.',
        difficulty: 'Trung bình',
        requirements: ['Virtual lab environment', 'Understanding of periodic table'],
        hints: [
        ...
        solution: 'P-type: thiếu electron (holes), N-type: thừa electron (free electrons)',
    ...
    caseStudies: [
      {
        ...
        challenge: 'Phát triển chip memory 3nm với performance cao và tiết kiệm năng lượng cho mobile devices',
        solution: 'Áp dụng FinFET technology và AI-optimized layout design, kết hợp advanced lithography',
        results: '30% improvement trong speed, 50% reduction trong power consumption so với thế hệ trước',
        insights: [
    ...
    labTechniques: ['Crystal Growth', 'Doping Process', 'Photolithography Basics', 'Electrical Testing']
  },
  {
    id: 'ic-design-vlsi',
    title: 'IC Design & VLSI Technology',
    description: 'Học cách thiết kế integrated circuits từ concept đến production. Sử dụng EDA tools professional để tạo ra chip layout thực tế.',
    duration: '240 phút',
    difficulty: 'Trung bình',
    ...
    exercises: [
      {
        ...
        description: 'Sử dụng Verilog để thiết kế 4-bit adder, từ logic gates đến complete circuit layout.',
        difficulty: 'Trung bình',
        requirements: ['Verilog simulator', 'EDA software access', 'Digital logic knowledge'],
        hints: [
        ...
        solution: 'Complete 4-bit ripple carry adder với proper timing và verification',
        expectedOutput: 'Working adder circuit với simulation results đúng'
      },
      {
        title: 'Power Analysis & Optimization',
        description: 'Phân tích power consumption của circuit design và áp dụng techniques để reduce power usage.',
        difficulty: 'Nâng cao',
        requirements: ['Power analysis tools', 'Understanding of CMOS technology'],
        hints: [
        ...
        solution: 'Power-optimized design với 20-30% reduction trong total power',
    ...
    caseStudies: [
      {
        ...
        challenge: 'Thiết kế low-power processor cores cho IoT applications với strict power budget',
        solution: 'Implement advanced power gating, adaptive voltage scaling và AI-based workload prediction',
        results: '40% power reduction while maintaining performance targets, enabling longer battery life',
        insights: [
    ...
    labTechniques: ['Verilog HDL', 'Logic Synthesis', 'Place & Route', 'Timing Analysis', 'Power Analysis']
  },
  {
    id: 'fabrication-cleanroom',
    title: 'Chip Fabrication & Clean Room Technology',
    description: 'Khám phá quá trình sản xuất chip thực tế trong clean room. Từ wafer preparation đến final testing - hiểu mọi bước trong semiconductor manufacturing.',
    duration: '200 phút',
    difficulty: 'Trung bình',
    ...
    exercises: [
      {
        ...
        description: 'Tham quan virtual clean room facility và hiểu các safety protocols, contamination control measures.',
        difficulty: 'Cơ bản',
        ...
        solution: 'Complete understanding của clean room protocols và safety measures',
        expectedOutput: 'Có thể explain clean room requirements và contamination control'
      },
      {
        title: 'Photolithography Simulation',
        description: 'Mô phỏng photolithography process để create circuit patterns trên wafer surface.',
        difficulty: 'Nâng cao',
        requirements: ['Lithography simulation software', 'Understanding of optics'],
        hints: [
    ...
    caseStudies: [
      {
        ...
        challenge: 'Establish cost-effective packaging và testing facilities trong Vietnam để serve Asian market',
        solution: 'Investment trong state-of-art equipment, training local workforce, và establish quality standards',
        results: 'Vietnam trở thành major hub cho semiconductor assembly với $15B+ investment',
        insights: [
    ...
    labTechniques: ['Photolithography', 'Etching', 'Chemical Vapor Deposition', 'Ion Implantation', 'Metrology']
  },
  {
    id: 'advanced-nodes-ai',
    title: 'Advanced Technology Nodes & AI Chips',
    description: 'Dive deep vào cutting-edge 3nm, 2nm technology và specialized AI accelerator chips. Học cách design cho next-generation applications.',
    duration: '220 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        description: 'Thiết kế specialized chip architecture cho machine learning workloads, optimize cho matrix operations và parallel processing.',
        difficulty: 'Nâng cao',
        requirements: ['Advanced EDA tools', 'ML framework knowledge', 'Parallel computing understanding'],
        hints: [
        ...
        solution: 'Complete AI accelerator design với performance specifications met',
        expectedOutput: 'Functional AI chip design với verified performance metrics'
      },
      {
        title: 'Quantum Effects Mitigation',
        description: 'Analyze quantum tunneling và other effects trong advanced nodes, develop solutions để maintain reliable operation.',
        difficulty: 'Nâng cao',
        requirements: ['Quantum physics knowledge', 'Simulation tools', 'Advanced mathematics'],
        hints: [
    ...
    caseStudies: [
      {
        ...
        challenge: 'Compete với global giants trong AI chip development với limited resources',
        solution: 'Focus on specialized applications, leverage local talent, partner với international foundries',
        results: 'Several successful startups với niche AI accelerator products',
        insights: [
    ...
    labTechniques: ['Advanced TCAD Simulation', 'Machine Learning Accelerator Design', 'Quantum Effect Modeling', 'AI Chip Verification']
  },
  {
    id: 'industry-career-pathways',
    title: 'Industry Careers & Vietnam Opportunities',
    description: 'Khám phá career opportunities trong semiconductor industry tại Vietnam. Từ technical roles đến business development - hiểu job market và salary expectations.',
    duration: '150 phút',
    difficulty: 'Cơ bản',
    ...
    exercises: [
      {
        ...
        description: 'Research major semiconductor companies tại Vietnam, analyze their business models, job openings và growth prospects.',
        difficulty: 'Cơ bản',
        requirements: ['Internet access', 'Research skills', 'Report writing ability'],
        hints: [
      ...
      },
      {
        ...
        description: 'Build professional portfolio showcasing semiconductor knowledge và technical projects for job applications.',
        difficulty: 'Trung bình',
        requirements: ['Portfolio platform', 'Project documentation', 'Professional photos'],
        hints: [
        ...
        expectedOutput: 'Attractive portfolio demonstrating semiconductor expertise'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        challenge: 'Local engineers advancing to senior positions trong global semiconductor companies',
        solution: 'Continuous learning, international certification, cross-cultural communication skills',
        results: 'Many Vietnamese engineers now lead major projects at top semiconductor companies',
        insights: [
    ...
    labTechniques: ['Industry Analysis', 'Professional Networking', 'Technical Communication', 'Career Planning']
  }
];
