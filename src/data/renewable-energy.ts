...
export const renewableEnergyLessons: RenewableEnergyLesson[] = [
  {
    ...
    description: 'Khám phá công nghệ năng lượng mặt trời từ photovoltaic cells đến complete solar farm systems. Học cách design và optimize solar installations cho climate Việt Nam.',
    duration: '180 phút',
    difficulty: 'Cơ bản',
    ...
    exercises: [
      {
        ...
        description: 'Thiết kế complete solar system cho typical Vietnamese household, calculate energy needs và system specifications.',
      ...
      },
      {
        ...
        description: 'Test different solar panel types under various conditions để understand performance characteristics.',
        difficulty: 'Nâng cao',
  ...
  },
  {
    ...
    description: 'Explore wind energy technology từ aerodynamics đến complete wind farm development. Focus trên offshore wind potential của Vietnam coastline.',
    duration: '200 phút',
    difficulty: 'Trung bình',
    ...
    exercises: [
      {
        ...
        description: 'Analyze wind data từ potential Vietnamese wind farm sites để determine viability và optimal turbine selection.',
        difficulty: 'Nâng cao',
      ...
      },
      {
        ...
        description: 'Design offshore wind farm layout cho Vietnam coastal waters, considering environmental và technical constraints.',
        difficulty: 'Nâng cao',
    ...
    technologies: ['Horizontal Axis Turbines', 'Fixed Foundation', 'Floating Platforms', 'Power Electronics', 'Grid Integration']
  },
  {
    id: 'energy-storage-systems',
    title: 'Energy Storage & Smart Grid Integration',
    description: 'Master advanced energy storage technologies và grid integration strategies. Essential cho managing renewable energy variability trong modern power systems.',
    duration: '160 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        description: 'Design battery energy storage system cho grid-scale renewable integration trong Vietnam power network.',
        difficulty: 'Nâng cao',
  ...
  },
  {
    ...
    description: 'Explore hydroelectric technology từ large dams đến micro-hydro systems. Focus trên Vietnam\'s abundant water resources và small-scale applications.',
    duration: '170 phút',
    difficulty: 'Trung bình',
    ...
    exercises: [
      {
        ...
        description: 'Design micro-hydro system cho remote village trong Vietnam mountains using local water resources.',
        difficulty: 'Trung bình',
    ...
    technologies: ['Pelton Turbines', 'Francis Turbines', 'Crossflow Turbines', 'Synchronous Generators', 'Power Electronics']
  },
  {
    id: 'renewable-economics-policy',
    title: 'Renewable Energy Economics & Policy in Vietnam',
    description: 'Understand economics, policy framework và business models cho renewable energy development trong Vietnam. Essential cho project development và investment decisions.',
    duration: '140 phút',
    difficulty: 'Trung bình',
    ...
    technologies: ['Financial Modeling', 'Policy Analysis', 'Project Development', 'Risk Assessment', 'Market Analysis']
  }
];
