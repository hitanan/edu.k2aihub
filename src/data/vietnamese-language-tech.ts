...
export const vietnameseLangTechLessons: VietnameseLangTechLesson[] = [
  {
    ...
    description: 'Tìm hiểu đặc điểm của tiếng Việt trong xử lý ngôn ngữ tự nhiên. Học cách tokenization, word segmentation và các thách thức riêng của tiếng Việt.',
  ...
  },
  {
    ...
    description: 'Phát triển chatbot AI hiểu và trả lời tiếng Việt tự nhiên. Học intent recognition, entity extraction và conversation management cho tiếng Việt.',
  ...
  },
  {
    ...
    description: 'Phát triển ứng dụng voice AI cho tiếng Việt: speech-to-text, text-to-speech và voice assistant. Học cách handle Vietnamese pronunciation và tone.',
    ...
    resources: [
      {
        title: 'Vietnamese Speech Recognition Toolkit',
        url: 'https://github.com/vais-ral/CogSima-2022-Vietnamese-Speech',
        type: 'tool',
        description: 'Tools for Vietnamese speech processing'
      }
    ]
  }
];
