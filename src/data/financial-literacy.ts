...
export const finLitLessons: FinLitLesson[] = [
  {
    id: 'personal-budgeting-fundamentals',
    title: 'Bài 1: Personal Budgeting & Financial Planning',
    description: 'Master personal finance fundamentals: budgeting methods, expense tracking, financial goals setting. Sử dụng apps và tools để quản lý tài chính cá nhân hiệu quả.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Comprehensive financial dashboard với automated tracking, clear goals, và actionable optimization strategies'
      }
    ],
    ...
    resources: [
      {
        ...
        type: 'app',
        description: 'Comprehensive budgeting app với zero-based budgeting methodology'
      },
      {
        title: 'Mint Personal Finance',
        url: 'https://mint.intuit.com',
        type: 'platform',
        description: 'Free financial tracking với automatic categorization và credit monitoring'
      }
    ],
    caseStudies: [
      {
        ...
        challenge: 'Graduated với 200M VND student debt, high lifestyle inflation after first job, no savings despite 30M VND monthly income',
        solution: 'Implemented aggressive budgeting: moved to smaller apartment, cooked at home, used debt avalanche method. Allocated 15M VND monthly to debt payment while building 1-month emergency fund.',
        results: 'Debt free trong 18 months, built 6-month emergency fund, started investing 8M VND monthly. Net worth increased from -200M to +150M VND trong 3 years.',
        insights: [
  ...
  },
  {
    ...
    description: 'Learn investment basics: stocks, bonds, ETFs, real estate. Build diversified portfolio với risk management và long-term wealth building strategies.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Complete investment portfolio với detailed allocation, risk management plan, và performance monitoring system'
      }
    ],
    realWorldApplications: [
    ...
    resources: [
      {
        ...
        type: 'platform',
        description: 'Low-cost index funds và ETFs với comprehensive investment tools'
      },
      {
        title: 'Morningstar Investment Research',
        url: 'https://www.morningstar.com',
        type: 'platform',
        description: 'Professional investment analysis, fund ratings, và portfolio tools'
      }
    ],
    caseStudies: [
      {
        ...
        challenge: 'Started investing late at age 30, wanted to retire by 50 với limited investment knowledge và moderate income',
        solution: 'Focused on low-cost index fund investing: 80% stocks, 20% bonds. Maximized retirement account contributions, invested 40% of income through extreme frugality.',
        results: 'Portfolio grew from 0 to 2.8 billion VND trong 15 years. Achieved financial independence at age 45, 5 years ahead of goal.',
        insights: [
