...
export const aiArtLessons: AiArtLesson[] = [
  {
    ...
    description: 'Master AI image generation với Midjourney, DALL-E, Stable Diffusion. Học prompt engineering techniques, style control, và advanced generation workflows.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Complete brand identity system created using AI art generation với professional quality deliverables và comprehensive documentation'
      }
    ],
    ...
    caseStudies: [
      {
        ...
        challenge: 'Create complete brand identity for sustainable fashion startup trong 2 weeks với limited budget, requiring dozens của visual assets và consistent style across all materials.',
        solution: 'Implemented multi-platform AI art generation workflow: Midjourney cho conceptual exploration, DALL-E cho precision work, Stable Diffusion for volume production. Developed comprehensive prompt library và post-processing system.',
        results: 'Delivered 150+ brand assets trong timeline với 90% cost reduction compared to traditional design process. Brand identity received design awards và helped client secure $2M funding round.',
        insights: [
  ...
  },
  {
    ...
    description: 'Create stunning videos với AI tools. Master RunwayML, Pika Labs, Stable Video Diffusion cho video generation, motion graphics, và cinematic storytelling.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Complete video marketing campaign với AI-generated content, professional post-production, và multi-platform optimization'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        challenge: 'Create viral marketing campaign for tech startup với $5,000 budget và 1-week deadline, requiring multiple video formats cho different platforms và demographics.',
        solution: 'Implemented AI video generation workflow với RunwayML và Pika Labs, creating 25+ video variations trong 3 days. Used A/B testing to optimize content for each platform\'s algorithm.',
        results: 'Campaign achieved 15M+ views across platforms, 300% increase trong website traffic, $200,000 trong pre-orders. AI-generated content outperformed traditional video ads by 40% engagement rate.',
        insights: [
