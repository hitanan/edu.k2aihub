    ...
    exercises: [
      {
        ...
        expectedResults:
          'Monodisperse gold nanoparticles với controlled size (10-50 nm) suitable cho biomedical applications',
        solution:
          'Optimized synthesis produces stable, biocompatible nanoparticles ready cho pharmaceutical applications trong Vietnamese healthcare',
      },
      {
        title: 'Carbon Nanotube Production for Vietnamese Electronics',
        description:
          'Develop carbon nanotube synthesis process optimized cho electronic device applications trong Vietnamese manufacturing',
        difficulty: 'Nâng cao',
        materials: [
        ...
        expectedResults:
          'High-quality carbon nanotubes với excellent electrical properties suitable cho electronic applications',
        solution:
          'Controlled synthesis enables production của carbon nanotubes meeting specifications cho Vietnamese electronics manufacturing',
      },
    ],
    ...
    caseStudies: [
      {
        ...
        problem:
          'Developing nanomedicine solutions cho Vietnamese healthcare challenges including drug delivery và diagnostic applications',
        solution:
          'Established comprehensive nanomaterial synthesis và characterization facilities với focus trên biomedical applications',
        impact:
          'Developed 5+ nanomedicine prototypes, trained 50+ researchers, established industry partnerships cho commercialization',
        innovations: [
    ...
    exercises: [
      {
        ...
        description:
          'Develop nanoparticle-based drug delivery system targeting liver cancer common trong Vietnamese population',
        difficulty: 'Nâng cao',
        materials: [
        ...
        expectedResults:
          'Targeted nanoparticles delivering 5x higher drug concentration to cancer cells vs. normal cells',
        solution:
          'Optimized drug delivery system enables effective cancer treatment với reduced side effects cho Vietnamese patients',
      },
      {
        title: 'Diagnostic Nanoparticles for Infectious Disease',
        description:
          'Create diagnostic nanoparticles cho rapid detection của infectious diseases prevalent trong Vietnamese tropical climate',
        difficulty: 'Nâng cao',
        materials: [
    ...
    caseStudies: [
      {
        ...
        problem:
          'Implementing nanomedicine technologies cho advanced cancer treatment trong Vietnamese healthcare system',
        solution:
          'Established nanomedicine research program với international partnerships developing targeted therapy protocols',
        impact:
          'Improved cancer treatment outcomes, reduced side effects, established Vietnamese nanomedicine capabilities',
        innovations: [
    ...
    exercises: [
      {
        ...
        description:
          'Develop nanomaterial-based water treatment system addressing pollution trong Mekong Delta waterways',
        difficulty: 'Trung bình',
        materials: [
      ...
      },
      {
        ...
        description:
          'Create nanocoating materials cho buildings that actively purify air trong Vietnamese urban environments',
        difficulty: 'Trung bình',
        materials: [
