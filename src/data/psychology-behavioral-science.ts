...
export const psychologyBehavioralScienceLessons: PsychologyBehavioralScienceLesson[] = [
  {
    ...
    description:
      'Áp dụng principles của psychology vào business strategy, leadership, team dynamics, và organizational behavior trong Vietnamese workplace culture.',
    duration: '185 phút',
    ...
    prerequisites: ['Basic business knowledge', 'Interest in human behavior và psychology'],
    ...
    exercises: [
      {
        ...
        solution:
          'Evidence-based approach combining self-awareness, feedback integration, và targeted skill development',
      },
    ],
    ...
    caseStudies: [
      {
        ...
        solution:
          'Psychology-based leadership development program, cultural adaptation training, peer coaching networks',
  ...
  },
  {
    ...
    description:
      'Understand consumer psychology, decision-making processes, và behavioral triggers để create more effective marketing strategies cho Vietnamese market.',
    duration: '200 phút',
    difficulty: 'Trung bình',
    ...
    prerequisites: ['Basic marketing knowledge', 'Understanding of Vietnamese consumer culture'],
    vietnameseCulturalContext: [
    ...
    exercises: [
      {
        ...
        solution:
          'Campaign incorporating social proof, scarcity, authority, và cultural relevance để drive desired consumer behavior',
      },
    ],
    realWorldApplications: [
  ...
  },
  {
    ...
    description:
      'Apply workplace psychology principles trong HR practices, employee wellbeing, performance management, và creating positive organizational culture.',
    duration: '175 phút',
    difficulty: 'Trung bình',
    ...
    prerequisites: ['HR management fundamentals', 'Basic understanding of psychology principles'],
    vietnameseCulturalContext: [
    ...
    exercises: [
      {
        ...
        solution:
          'Multi-faceted program addressing stress management, work-life balance, social connection, và personal development',
      },
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        solution:
          'Psychology-based engagement surveys, personalized career development, flexible work arrangements, mental health support',
  ...
  },
  {
    ...
    description:
      'Explore digital mental health solutions, wellness apps, và technology-enabled therapeutic interventions với focus trên Vietnamese cultural context.',
    duration: '190 phút',
    difficulty: 'Trung bình',
    ...
    exercises: [
      {
        ...
        solution:
          'App combining evidence-based interventions với Vietnamese cultural values, language, và help-seeking patterns',
      },
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        solution:
          'Anonymous counseling platform, culturally-adapted therapy content, peer support communities, family education resources',
  ...
  },
  {
    ...
    description:
      'Understand cognitive biases, decision-making patterns, và behavioral economics principles để improve business strategy và policy design.',
    duration: '195 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        solution:
          'Multi-component intervention using commitment devices, social proof, loss aversion, và default options',
      },
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        solution:
          'Behavioral design features including savings goals, spending categorization, social comparison, micro-investments',
