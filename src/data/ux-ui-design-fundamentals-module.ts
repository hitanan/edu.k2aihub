...
export const uxUiDesignFundamentalsModuleData: ModuleData = {
  ...
  description:
    'Trong thời đại số, khả năng thiết kế trải nghiệm người dùng tốt là kỹ năng có giá trị cao. Module này dạy bạn từ cơ bản về UX/UI design, user research, visual design principles đến design thinking để tạo ra những sản phẩm số thân thiện và hiệu quả.',
  level: 'Trung bình',
  duration: '7-8 giờ',
  ...
  prerequisites: ['Không có yêu cầu kỹ thuật đặc biệt', 'Quan tâm đến user experience và design'],
  careerOutcomes: [
    'UX/UI Designer',
    'Product Designer',
    'User Researcher',
  ...
  relatedModules: [K2Module.DigitalMarketing, K2Module.CriticalThinking, K2Module.CommunicationSkills],
