...
export const RealEstateTechnologyLessons: RealEstateTechLesson[] = [
  {
    ...
    description:
      'Khám phá cách mạng PropTech đang transform ngành bất động sản toàn cầu. Từ các ứng dụng mobile đến AI-powered valuation, blockchain property records đến smart contracts. Tìm hiểu các trends, technologies và business models đang reshape real estate industry.',
    duration: '190 phút',
    ...
    exercises: [
      {
        ...
        solution:
          "Sử dụng frameworks như SWOT analysis, Porter's Five Forces và TAM-SAM-SOM sizing. Research companies như PropertyGuru, Batdongsan.com.vn, và international players như Zillow, Compass để understand best practices.",
      },
      {
        ...
        solution:
          'Follow design thinking methodology với human-centered approach. Use tools như Figma cho UI design, Draw.io cho system architecture, và Postman cho API documentation. Consider microservices architecture cho scalability.',
      },
    ],
    ...
    caseStudies: [
      {
        ...
        solution:
          'Comprehensive PropTech platform với property listings, agent tools, financial services và data analytics',
...

  {
    ...
    description:
      'Master nghệ thuật tạo immersive virtual property experiences. Từ 360° photography, VR walkthrough development đến interactive floor plans và augmented reality staging. Học cách sử dụng Matterport, CloudPano và custom VR development để revolutionize property marketing.',
    duration: '220 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        difficulty: 'Trung bình',
        materials: [
          '360° camera (Insta360, Ricoh Theta)',
          'Tripod và stabilization equipment',
          'Lighting equipment',
        ...
        solution:
          'Sử dụng HDR photography techniques để capture optimal lighting. Tools như PTGui cho advanced stitching, Adobe Lightroom cho color correction, và Kuula hoặc Roundme cho hosting tours.',
      },
      {
        ...
        solution:
          'Unity với XR Toolkit cung cấp cross-platform VR development. Use photogrammetry tools như RealityCapture để create realistic 3D models từ photos. Implement comfortable VR interaction patterns để avoid motion sickness.',
      },
    ],
    realWorldApplications: [
...

  {
    ...
    description:
      'Explore tương lai của building management với IoT sensors, smart home automation và predictive maintenance. Tìm hiểu cách integrate various systems từ HVAC, security, lighting đến energy management. Master platforms như SmartThings, Home Assistant và enterprise building automation.',
    duration: '230 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        materials: [
          ...
          'Gateway devices và routers',
          'Cloud IoT platform accounts',
        ...
        solution:
          'Use AWS IoT Core hoặc Azure IoT Hub cho cloud connectivity. LoRaWAN cho long-range, low-power sensors. Implement MQTT protocol cho efficient data transmission. Create digital twin của building trong cloud.',
      },
      {
        ...
        solution:
          'Use time series analysis với LSTM neural networks. Azure Machine Learning hoặc AWS SageMaker cho model training. Integration với CMMS systems như UpKeep hoặc Fiix cho work order management.',
      },
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        innovations: [
          ...
          'Smart lighting với occupancy detection',
          'Mobile app cho tenant services',
        ],
      },
    ],
    resources: [
...

  {
    ...
    description:
      'Harness power của big data và artificial intelligence để revolutionize real estate decision making. Từ property valuation models, market trend analysis đến investment analytics và risk assessment. Master tools như Python, Tableau và specialized PropTech analytics platforms.',
    duration: '200 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        solution:
          'Use gradient boosting algorithms như XGBoost hoặc LightGBM cho best performance. Incorporate external data như school ratings, crime statistics, economic indicators. Use geospatial analysis để capture location premiums.',
      },
      {
        ...
        solution:
          'Use APIs từ real estate platforms, government databases, economic data providers. Implement ETL processes với tools như Apache Airflow. Create mobile-responsive design với responsive framework.',
      },
    ],
    realWorldApplications: [
...

  {
    ...
    description:
      'Explore cutting-edge applications của blockchain trong real estate từ smart contracts, tokenized property ownership đến decentralized financing solutions. Tìm hiểu DeFi protocols cho real estate, NFT property certificates và cryptocurrency payment integration.',
    duration: '210 phút',
    difficulty: 'Cao',
    ...
    exercises: [
      {
        ...
        solution:
          'Use OpenZeppelin libraries cho secure contract development. Implement multi-signature wallets cho enhanced security. Use Chainlink oracles cho external data feeds như property appraisals.',
      },
      {
        ...
        expectedResults:
          'Complete tokenization platform enabling fractional property investment với regulatory compliance',
        solution:
          'Use security token standards như ERC-1400 for compliance. Integrate với services như Polymath hoặc Harbor cho regulatory frameworks. Use IPFS cho decentralized document storage.',
      },
    ],
    realWorldApplications: [
