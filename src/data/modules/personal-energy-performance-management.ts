...
export const personalEnergyPerformanceManagementModule: ModuleData<EnergyManagementLesson> = {
  ...
  lessons: [
    {
      ...
      description:
        'Khám phá bốn chiều năng lượng: thể chất, cảm xúc, tinh thần và tâm hồn.',
      duration: '45 phút',
      difficulty: 'Cơ bản',
      objectives: [
    ...
    },
    {
      ...
      description:
        'Tìm hiểu về vai trò của dinh dưỡng, giấc ngủ và vận động trong việc duy trì năng lượng thể chất.',
      duration: '60 phút',
    ...
    },
    {
      ...
      description:
        'Học cách quản lý cảm xúc tiêu cực và nuôi dưỡng cảm xúc tích cực để đối phó với áp lực.',
      duration: '60 phút',
      difficulty: 'Trung bình',
      objectives: [
