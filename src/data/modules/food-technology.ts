...
export const foodTechnologyLessons: BaseLessonData[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'CCP là một bước trong quy trình sản xuất mà tại đó việc kiểm soát có thể được áp dụng và là cần thiết để ngăn chặn hoặc loại bỏ một mối nguy về an toàn thực phẩm hoặc giảm nó xuống mức có thể chấp nhận được. Ví dụ, bước nấu chín là một CCP để tiêu diệt vi khuẩn gây bệnh.',
      },
      {
        question: 'Làm thế nào để một nhà hàng nhỏ có thể áp dụng các nguyên tắc an toàn thực phẩm?',
        answer:
          'Một nhà hàng nhỏ có thể bắt đầu bằng cách thực hiện các chương trình tiên quyết (PRPs) như: vệ sinh cá nhân tốt, kiểm soát nhiệt độ (giữ nóng thực phẩm nóng, giữ lạnh thực phẩm lạnh), ngăn ngừa ô nhiễm chéo (sử dụng thớt riêng cho thực phẩm sống và chín), và kiểm soát côn trùng gây hại.',
      },
      {
        question: 'Tại sao việc ghi chép lại hồ sơ trong hệ thống HACCP lại quan trọng?',
        answer:
          'Việc ghi chép hồ sơ (ví dụ: nhật ký nhiệt độ tủ lạnh, hồ sơ đào tạo nhân viên) là bằng chứng cho thấy hệ thống an toàn thực phẩm đang được thực hiện đúng cách. Nó rất quan trọng cho việc xác minh nội bộ, kiểm tra của cơ quan quản lý và để điều tra nếu có sự cố xảy ra.',
      },
      {
        question: 'Dị ứng thực phẩm là một mối nguy an toàn thực phẩm không?',
        answer:
          'Có, các chất gây dị ứng (như đậu phộng, hải sản, sữa) được coi là một mối nguy hóa học. Các cơ sở sản xuất và nhà hàng phải có quy trình rõ ràng để ngăn ngừa ô nhiễm chéo và ghi nhãn chính xác các sản phẩm có chứa chất gây dị ứng để bảo vệ người tiêu dùng.',
      },
      {
        question: 'Thực hành sản xuất tốt (GMP) là gì?',
        answer:
          'GMP (Good Manufacturing Practices) là các yêu cầu và hướng dẫn nhằm đảm bảo sản phẩm được sản xuất một cách nhất quán và kiểm soát theo các tiêu chuẩn chất lượng. Nó bao gồm các khía cạnh như thiết kế nhà xưởng, vệ sinh, thiết bị, và quy trình vận hành.',
      },
      {
        question: 'Làm thế nào để kiểm soát chất lượng nguyên liệu đầu vào?',
        answer:
          'Kiểm soát chất lượng nguyên liệu đầu vào bắt đầu bằng việc lựa chọn các nhà cung cấp uy tín. Cần thiết lập các tiêu chuẩn chất lượng rõ ràng cho từng loại nguyên liệu và thực hiện kiểm tra khi nhận hàng (ví dụ: kiểm tra cảm quan, đo nhiệt độ, hoặc lấy mẫu xét nghiệm) để đảm bảo chúng đáp ứng yêu cầu trước khi đưa vào sản xuất.',
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Umami là vị cơ bản thứ năm, thường được mô tả là "vị ngọt thịt" hoặc "vị ngon". Trong quá trình lên men nước mắm hoặc tương, các enzyme từ vi sinh vật sẽ phân giải protein trong cá hoặc đậu nành thành các axit amin, trong đó có glutamate. Glutamate là hợp chất chính tạo ra vị umami đậm đà.',
      },
      {
        question: 'Men khởi động (starter culture) là gì?',
        answer:
          'Men khởi động là một tập hợp các vi sinh vật được chọn lọc (vi khuẩn, nấm men, hoặc nấm mốc) được thêm vào nguyên liệu để bắt đầu và kiểm soát quá trình lên men. Việc sử dụng men khởi động giúp đảm bảo sản phẩm cuối cùng có chất lượng và hương vị nhất quán.',
      },
      {
        question: 'Tại sao một số loại phô mai lại có mùi rất nồng?',
        answer:
          'Mùi nồng của một số loại phô mai (như phô mai xanh) là kết quả của hoạt động của các vi sinh vật (nấm mốc, vi khuẩn) trong quá trình ủ. Chúng phân giải chất béo và protein trong sữa thành các hợp chất thơm dễ bay hơi, tạo ra hương vị phức tạp và đặc trưng.',
      },
      {
        question: 'Làm thế nào để làm sữa chua tại nhà?',
        answer:
          'Để làm sữa chua, bạn cần đun nóng sữa để tiệt trùng, sau đó để nguội đến khoảng 40-45°C. Tiếp theo, bạn hòa một ít men (có thể dùng sữa chua không đường mua sẵn) vào sữa, rồi ủ ấm trong khoảng 6-8 tiếng. Trong thời gian này, vi khuẩn lactic sẽ lên men đường lactose trong sữa thành axit lactic, làm sữa đông lại và tạo ra vị chua đặc trưng.',
      },
      {
        question: 'Kombucha là gì?',
        answer:
          'Kombucha là một loại trà lên men có vị chua ngọt và có ga nhẹ. Nó được làm bằng cách thêm một "con giống" gọi là SCOBY (Symbiotic Culture of Bacteria and Yeast - Cộng sinh của vi khuẩn và nấm men) vào trà ngọt. SCOBY sẽ lên men trà, tạo ra axit axetic, axit gluconic và một lượng nhỏ cồn.',
      },
      {
        question: 'Sự khác biệt giữa dưa chua và kim chi là gì?',
        answer:
          'Cả hai đều là rau củ lên men, nhưng có sự khác biệt về nguyên liệu và quy trình. Dưa chua của Việt Nam thường chỉ được lên men với muối và nước, tạo ra vị chua tự nhiên. Kim chi của Hàn Quốc phức tạp hơn, được ướp với nhiều loại gia vị như bột ớt, tỏi, gừng, và nước mắm, tạo ra hương vị cay, nồng và phức hợp hơn.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Canh tác hữu cơ là một phương pháp nông nghiệp không sử dụng phân bón hóa học tổng hợp, thuốc trừ sâu, thuốc diệt cỏ, hoặc sinh vật biến đổi gen (GMO). Thay vào đó, nó tập trung vào việc duy trì sức khỏe của đất thông qua phân compost, luân canh cây trồng và các phương pháp tự nhiên khác.',
      },
      {
        question: 'Dấu chân carbon (carbon footprint) của thực phẩm là gì?',
        answer:
          'Dấu chân carbon của thực phẩm là tổng lượng khí nhà kính được thải ra trong suốt vòng đời của nó, từ sản xuất, chế biến, vận chuyển, đến tiêu thụ và thải bỏ. Thực phẩm có nguồn gốc động vật và được vận chuyển bằng đường hàng không thường có dấu chân carbon cao nhất.',
      },
      {
        question: 'Thực phẩm "từ trang trại đến bàn ăn" (farm-to-table) có ý nghĩa gì?',
        answer:
          'Đây là một phong trào xã hội nhằm thúc đẩy việc phục vụ thực phẩm địa phương tại các nhà hàng và cơ sở ăn uống. Bằng cách giảm thiểu các bước trung gian trong chuỗi cung ứng, nó giúp đảm bảo thực phẩm tươi ngon hơn, hỗ trợ nông dân địa phương và giảm tác động môi trường từ việc vận chuyển.',
      },
      {
        question: 'Làm thế nào để giảm lãng phí thực phẩm tại nhà?',
        answer:
          'Bạn có thể giảm lãng phí bằng cách: lên kế hoạch bữa ăn và mua sắm theo danh sách, bảo quản thực phẩm đúng cách để giữ được lâu hơn, tận dụng thức ăn thừa để chế biến các món mới, và hiểu sự khác biệt giữa ngày "sử dụng trước" (use by) và "tốt nhất trước" (best before).',
      },
      {
        question: 'Nông nghiệp đô thị (urban agriculture) là gì và lợi ích của nó là gì?',
        answer:
          'Nông nghiệp đô thị là việc trồng trọt, chế biến và phân phối thực phẩm trong hoặc xung quanh các thành phố. Lợi ích của nó bao gồm: cung cấp thực phẩm tươi sống cho người dân thành thị, giảm quãng đường vận chuyển thực phẩm, tạo không gian xanh, và giáo dục cộng đồng về nguồn gốc thực phẩm.',
      },
      {
        question: 'Thực phẩm biến đổi gen (GMO) có bền vững không?',
        answer:
          'Đây là một chủ đề gây tranh cãi. Những người ủng hộ cho rằng GMO có thể tăng năng suất, giảm nhu cầu sử dụng thuốc trừ sâu và tạo ra các loại cây trồng chịu được hạn hán, góp phần vào an ninh lương thực. Tuy nhiên, những người phản đối lo ngại về các tác động tiềm tàng đối với đa dạng sinh học và sự phụ thuộc vào một số ít các công ty hạt giống lớn.',
      },
    ],
  },
];
