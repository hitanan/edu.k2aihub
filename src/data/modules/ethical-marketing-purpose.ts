...
export const ethicalMarketingPurposeModule: ModuleData = {
  ...
  industryApplications: [
    { name: 'Sustainable fashion và beauty brands', description: '' },
    { name: 'Organic food và beverage companies', description: '' },
    { name: 'Clean technology và renewable energy', description: '' },
    { name: 'Ethical finance và banking', description: '' },
    { name: 'Social enterprise marketing', description: '' },
    { name: 'Non-profit organization communications', description: '' },
    { name: 'Fair trade và ethical sourcing', description: '' },
    { name: 'Health và wellness with purpose', description: '' },
    { name: 'Educational institutions with social mission', description: '' },
    { name: 'B-Corp certified companies', description: '' },
  ],
