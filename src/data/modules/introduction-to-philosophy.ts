  ...
  lessons: [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Khoa học sử dụng phương pháp thực nghiệm để kiểm tra các giả thuyết về thế giới vật chất. Triết học thường giải quyết các câu hỏi không thể trả lời chỉ bằng dữ liệu thực nghiệm, chẳng hạn như câu hỏi về đạo đức, ý nghĩa và bản chất của ý thức. Tuy nhiên, chúng thường xuyên giao thoa và bổ sung cho nhau.',
        },
        {
          question: 'Tại sao có nhiều trường phái triết học khác nhau? Không có câu trả lời nào đúng duy nhất sao?',
          answer:
            'Triết học khám phá những câu hỏi phức tạp nhất mà con người có thể tự hỏi. Các trường phái khác nhau đưa ra những cách tiếp cận và hệ thống giá trị khác nhau để trả lời những câu hỏi đó. Việc không có một câu trả lời đúng duy nhất chính là động lực để tư duy triết học tiếp tục phát triển.',
        },
        {
          question: 'Logic là gì và tại sao nó quan trọng trong triết học?',
          answer:
            'Logic là công cụ cơ bản của triết học. Đó là khoa học về lập luận đúng đắn. Nó giúp các nhà triết học xây dựng các lập luận chặt chẽ, xác định các lỗi ngụy biện và phân tích các khái niệm một cách rõ ràng. Không có logic, các cuộc tranh luận triết học sẽ chỉ là những ý kiến chủ quan.',
        },
        {
          question: 'Triết học có thực tế không?',
          answer:
            'Hoàn toàn có. Triết học giúp bạn suy nghĩ rõ ràng hơn về các quyết định hàng ngày, các giá trị cá nhân và các vấn đề xã hội. Nó cung cấp cho bạn một "bộ công cụ tinh thần" để sống một cuộc đời có ý thức và ý nghĩa hơn.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'Bởi vì những câu hỏi cơ bản mà họ đặt ra - về công lý, hạnh phúc, kiến thức, và mục đích sống - vẫn còn nguyên giá trị cho đến ngày nay. Việc nghiên cứu họ cho chúng ta thấy nguồn gốc của nhiều ý tưởng định hình thế giới hiện đại.',
        },
        {
          question: 'Triết học có phải chỉ là về ý kiến cá nhân không?',
          answer:
            'Không. Mặc dù triết học khám phá nhiều quan điểm, nó không chỉ đơn thuần là việc nêu ý kiến. Một quan điểm triết học phải được hỗ trợ bởi các lập luận logic, bằng chứng (nếu có), và phải được bảo vệ trước các phản biện. Mục tiêu là tìm kiếm câu trả lời hợp lý nhất, không phải là câu trả lời được nhiều người thích nhất.',
        },
        {
          question: '"Thí nghiệm tưởng tượng" trong triết học là gì?',
          answer:
            'Thí nghiệm tưởng tượng là những kịch bản giả định được thiết kế để khám phá các khái niệm và kiểm tra các lý thuyết. Ví dụ như "Vấn đề Xe điện" (Trolley Problem) hay "Bộ não trong thùng" (Brain in a Vat). Chúng giúp chúng ta suy nghĩ về các vấn đề phức tạp trong một môi trường được kiểm soát.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question:
            'Nếu chúng ta tự tạo ra ý nghĩa cho riêng mình, điều đó có làm cho ý nghĩa cuộc sống trở nên tùy tiện không?',
          answer:
