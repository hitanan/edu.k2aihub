...
export const energyManagementSmartGridModule: ModuleData = {
  ...
  subtitle: 'Tối ưu hóa việc sử dụng năng lượng và xây dựng lưới điện của tương lai.',
  description:
    'Khóa học này cung cấp kiến thức chuyên sâu về quản lý hiệu quả năng lượng, công nghệ lưới điện thông minh, và tích hợp năng lượng tái tạo. Học viên sẽ học cách thiết kế và triển khai các giải pháp năng lượng bền vững cho các ứng dụng công nghiệp, thương mại và đô thị.',
  level: 'Nâng cao',
  duration: '16 tuần',
  ...
  heroImageUrl: 'https://images.unsplash.com/photo-1587791630552-d63834a4d39a?auto=format&fit=crop&w=1470&q=80',
  icon: 'Zap',
  features: [
    'Kiểm toán và hiệu quả năng lượng',
    'Công nghệ lưới điện thông minh (Smart Grid)',
    'Tích hợp năng lượng tái tạo',
    'Chính sách và quy định năng lượng',
  ],
  objectives: [
    'Thực hiện kiểm toán năng lượng và đề xuất các giải pháp tiết kiệm chi phí.',
    'Thiết kế và triển khai các thành phần của lưới điện thông minh.',
    'Phân tích các chính sách năng lượng và tác động của chúng đến thị trường.',
    'Quản lý các dự án tích hợp năng lượng tái tạo vào lưới điện.',
  ],
  prerequisites: [
    'Kiến thức cơ bản về kỹ thuật điện.',
  ...
  marketDemand: {
    averageSalary: '25.000.000 - 55.000.000 VNĐ/tháng',
    jobGrowth: '30% (Cao)',
    hireDemand: 'Cao',
  },
  industryApplications: [
    'Tập đoàn điện lực và các công ty năng lượng',
    'Các khu công nghiệp và nhà máy sản xuất',
    'Các công ty tư vấn năng lượng và môi trường',
    'Cơ quan quản lý nhà nước về năng lượng',
  ],
  relatedModules: [
