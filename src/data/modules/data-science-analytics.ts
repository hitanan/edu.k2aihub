    ...
    faqs: [
      {
        ...
        answer:
          'Business Intelligence là quá trình sử dụng công nghệ để thu thập, tích hợp, phân tích và trình bày thông tin kinh doanh. Mục tiêu của BI là giúp các nhà lãnh đạo đưa ra các quyết định kinh doanh tốt hơn, nhanh hơn và dựa trên dữ liệu thực tế thay vì cảm tính.',
      },
      {
        question: 'Sự khác biệt giữa Power BI và Tableau là gì?',
        answer:
          'Cả hai đều là công cụ BI hàng đầu. Power BI (của Microsoft) thường được đánh giá cao về khả năng tích hợp chặt chẽ với hệ sinh thái Microsoft (Excel, Azure), dễ sử dụng cho người mới bắt đầu và có giá cả cạnh tranh. Tableau thường được coi là mạnh hơn về khả năng trực quan hóa dữ liệu phức tạp và linh hoạt hơn cho các nhà phân tích chuyên sâu.',
      },
      {
        question: 'Dashboard là gì và một dashboard tốt cần những yếu tố nào?',
        answer:
          'Dashboard là một giao diện trực quan cung cấp cái nhìn tổng quan về các chỉ số hiệu suất chính (KPIs) quan trọng nhất. Một dashboard tốt cần: rõ ràng (hiển thị đúng thông tin quan trọng), đơn giản (không làm người xem bị quá tải), và có tính hành động (giúp người xem biết cần phải làm gì tiếp theo).',
      },
      {
        question: 'Tại sao "kể chuyện" lại quan trọng khi làm việc với dữ liệu?',
        answer:
          'Con người có xu hướng ghi nhớ và bị thuyết phục bởi những câu chuyện hơn là những con số khô khan. Kể chuyện giúp tạo ra ngữ cảnh, kết nối cảm xúc và làm cho các insight từ dữ liệu trở nên dễ hiểu và đáng nhớ, từ đó thúc đẩy sự thay đổi và hành động trong một tổ chức.',
      },
      {
        question: 'SQL có vai trò gì trong Business Intelligence?',
        answer:
          'SQL (Structured Query Language) là ngôn ngữ tiêu chuẩn để truy vấn và lấy dữ liệu từ các cơ sở dữ liệu quan hệ. Đây là kỹ năng nền tảng cho bất kỳ chuyên gia BI nào, cho phép họ trích xuất chính xác dữ liệu cần thiết để phân tích và tạo báo cáo.',
      },
      {
        question: 'Self-service BI (BI tự phục vụ) là gì?',
        answer:
          'Đây là một phương pháp cho phép người dùng cuối (ví dụ: nhân viên phòng marketing, bán hàng) tự tạo báo cáo và dashboard của riêng họ mà không cần sự can thiệp liên tục từ bộ phận IT hoặc các nhà phân tích dữ liệu. Các công cụ như Power BI và Tableau rất mạnh trong việc hỗ trợ self-service BI.',
      },
      {
        question: 'Làm thế nào để chọn đúng KPI (Key Performance Indicator)?',
        answer:
          'Một KPI tốt phải trực tiếp liên quan đến mục tiêu kinh doanh của bạn. Thay vì theo dõi hàng chục chỉ số, hãy tập trung vào một vài chỉ số quan trọng nhất thực sự phản ánh sự thành công. Ví dụ, đối với một trang web thương mại điện tử, "Tỷ lệ chuyển đổi" quan trọng hơn nhiều so với "Số lượt xem trang".',
      },
      {
        question: 'DAX trong Power BI là gì?',
        answer:
          'DAX (Data Analysis Expressions) là một ngôn ngữ công thức được sử dụng trong Power BI (và các công cụ khác của Microsoft) để tạo ra các cột tính toán và các thước đo (measures) tùy chỉnh. Nó cho phép bạn thực hiện các phép tính phức tạp trên dữ liệu của mình, vượt ra ngoài những gì có thể làm với các tổng hợp cơ bản.',
      },
      {
        question: 'Làm thế nào để tránh việc trình bày thông tin sai lệch bằng biểu đồ?',
        answer:
          'Hãy luôn bắt đầu trục Y từ 0 để tránh phóng đại sự khác biệt. Sử dụng đúng loại biểu đồ cho dữ liệu của bạn. Đảm bảo rằng các nhãn và tiêu đề rõ ràng, không gây hiểu lầm. Tránh sử dụng các hiệu ứng 3D hoặc các yếu tố trang trí không cần thiết làm sai lệch nhận thức về tỷ lệ.',
      },
      {
        question: 'Xu hướng của ngành Business Intelligence trong tương lai là gì?',
        answer:
          'Các xu hướng chính bao gồm sự tích hợp ngày càng sâu của AI và Machine Learning (để tự động tạo insight), phân tích tăng cường (augmented analytics), xử lý ngôn ngữ tự nhiên (cho phép người dùng đặt câu hỏi cho dữ liệu bằng ngôn ngữ thông thường), và sự tập trung mạnh mẽ hơn vào quản trị dữ liệu và bảo mật.',
      },
    ],
  },
];
