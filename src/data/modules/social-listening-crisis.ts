...
export const socialListeningCrisisModule: ModuleData = {
  ...
  lessons: [
    {
      id: 'introduction-to-social-listening',
      title: 'Giới thiệu về Social Listening',
      description: 'Hiểu rõ khái niệm, tầm quan trọng và các công cụ phổ biến của social listening.',
      duration: '60',
      difficulty: 'Beginner',
      objectives: [],
