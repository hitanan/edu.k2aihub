...
import { environmentalClimateLessons } from '../lessons/environmental-science-climate';
...
export const environmentalScienceClimateModuleData: ModuleData = {
  ...
  description:
    'Khám phá khoa học về các hệ thống môi trường, tác động của biến đổi khí hậu và các giải pháp bền vững. Module này cung cấp kiến thức nền tảng về khoa học môi trường, giám sát, chính sách và các công nghệ xanh tiên tiến.',
