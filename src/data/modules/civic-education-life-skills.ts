  ...
  lessons: [
    {
      ...
      faqs: [
        ...
        },
        {
            ...
            answer: 'Quyền là những gì công dân được hưởng, được làm, được đòi hỏi (ví dụ: quyền được học tập, quyền tự do kinh doanh). Nghĩa vụ là những gì công dân bắt buộc phải làm cho nhà nước, cho xã hội (ví dụ: nghĩa vụ quân sự, nghĩa vụ đóng thuế).',
        },
        {
            question: 'Khi tham gia giao thông bằng xe đạp điện, học sinh có cần đội mũ bảo hiểm không?',
            answer: 'Có. Theo Luật Giao thông đường bộ, người điều khiển, người ngồi trên xe đạp máy (kể cả xe đạp điện) phải đội mũ bảo hiểm có cài quai đúng quy cách.',
        },
        {
            question: 'Hành vi bạo lực học đường có vi phạm pháp luật không?',
            answer: 'Chắc chắn có. Tùy theo mức độ, hành vi bạo lực học đường có thể bị xử phạt hành chính (phạt tiền) hoặc thậm chí bị truy cứu trách nhiệm hình sự về các tội như Cố ý gây thương tích hoặc Làm nhục người khác.',
        },
        {
            question: 'Luật An ninh mạng quy định những hành vi nào bị cấm trên không gian mạng?',
            answer: 'Một số hành vi bị cấm bao gồm: đăng tải thông tin sai sự thật gây hoang mang, xúc phạm danh dự nhân phẩm người khác, lừa đảo, tổ chức đánh bạc, và chia sẻ thông tin có nội dung đồi trụy, bạo lực.',
        },
        {
            question: 'Quyền trẻ em là gì?',
            answer: 'Quyền trẻ em là những quyền được pháp luật quốc tế và Việt Nam công nhận để đảm bảo trẻ em được sống, được bảo vệ, được phát triển và được tham gia. Ví dụ: quyền được khai sinh, quyền được chăm sóc sức khỏe, quyền được học tập.',
        },
        {
            question: 'Nếu bị người khác vu khống trên mạng xã hội, em nên làm gì?',
            answer: 'Đầu tiên, hãy thu thập bằng chứng (chụp màn hình). Sau đó, bạn có thể báo cáo bài viết với quản trị viên mạng xã hội. Nếu sự việc nghiêm trọng, bạn có quyền trình báo với cơ quan công an hoặc khởi kiện ra tòa án để yêu cầu bồi thường và xử lý người vi phạm.',
        },
        {
            question: 'Công dân có nghĩa vụ gì trong việc bảo vệ môi trường?',
            answer: 'Mọi công dân có nghĩa vụ bảo vệ môi trường, bao gồm việc không vứt rác bừa bãi, tham gia các hoạt động làm sạch môi trường, và tố giác các hành vi gây ô nhiễm nghiêm trọng.',
        },
        {
            question: 'Sự khác biệt giữa vi phạm hành chính và tội phạm là gì?',
            answer: 'Vi phạm hành chính là hành vi có mức độ nguy hiểm cho xã hội thấp hơn, xâm phạm các quy tắc quản lý nhà nước và thường bị xử phạt bằng các hình thức như cảnh cáo, phạt tiền. Tội phạm là hành vi nguy hiểm cho xã hội được quy định trong Bộ luật Hình sự và có thể bị xử phạt bằng các hình phạt nghiêm khắc hơn như tù có thời hạn, tù chung thân.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
            ...
            answer: 'Thông cảm là bạn cảm thấy tiếc cho hoàn cảnh của ai đó. Đồng cảm là bạn đặt mình vào vị trí của họ để thực sự thấu hiểu cảm xúc và góc nhìn của họ. Đồng cảm sâu sắc hơn và giúp kết nối con người tốt hơn.',
        },
        {
            question: 'Kỹ thuật "hít thở hộp" (box breathing) là gì?',
            answer: 'Đây là một kỹ thuật thư giãn đơn giản: Hít vào trong 4 giây, giữ hơi trong 4 giây, thở ra trong 4 giây, và giữ phổi trống trong 4 giây. Lặp lại chu trình này vài lần sẽ giúp làm chậm nhịp tim và giảm căng thẳng.',
        },
        {
            question: 'Viết nhật ký có giúp quản lý cảm xúc không?',
            answer: 'Có, viết nhật ký là một cách rất hiệu quả. Nó giúp bạn gọi tên và làm rõ những cảm xúc hỗn loạn, nhìn nhận vấn đề từ một góc độ khác, và theo dõi các kiểu mẫu cảm xúc của bản thân theo thời gian.',
        },
        {
            question: 'Làm gì khi cảm thấy tức giận?',
            answer: 'Thay vì phản ứng ngay lập tức, hãy thử dừng lại một chút. Rời khỏi tình huống nếu cần, tập trung vào hơi thở, hoặc thử vận động thể chất (như đi bộ nhanh) để giải tỏa năng lượng. Sau khi đã bình tĩnh hơn, hãy suy nghĩ về nguyên nhân và cách giải quyết.',
        },
        {
            question: 'Làm thế nào để thể hiện sự đồng cảm mà không bị cảm xúc của người khác lấn át?',
            answer: 'Hãy lắng nghe một cách tích cực, xác nhận cảm xúc của họ ("Tớ hiểu là cậu đang cảm thấy rất thất vọng"), nhưng đồng thời duy trì ranh giới cảm xúc của riêng mình. Nhớ rằng bạn ở đó để hỗ trợ, không phải để "hấp thụ" nỗi buồn của họ.',
        },
        {
            question: 'Tại sao việc đặt tên cho cảm xúc của mình lại hữu ích?',
            answer: 'Khi bạn có thể nói "Tôi đang cảm thấy thất vọng" thay vì chỉ cảm thấy "tệ", bạn đã chuyển cảm xúc từ một trạng thái mơ hồ sang một vấn đề cụ thể hơn. Điều này giúp não bộ dễ dàng xử lý và tìm ra hướng giải quyết.',
        },
        {
            question: 'Làm thế nào để xây dựng khả năng phục hồi (resilience) sau thất bại?',
            answer: 'Hãy xem thất bại như một cơ hội để học hỏi, tập trung vào những gì bạn có thể kiểm soát, duy trì một cái nhìn lạc quan, và tìm kiếm sự hỗ trợ từ mạng lưới bạn bè, gia đình. Khả năng phục hồi không phải là không bao giờ vấp ngã, mà là đứng dậy sau mỗi lần ngã.',
        },
        {
            question: 'Cảm xúc tích cực có lợi ích gì?',
            answer: 'Cảm xúc tích cực không chỉ làm chúng ta cảm thấy dễ chịu. Chúng còn giúp mở rộng tư duy, tăng cường khả năng sáng tạo và giải quyết vấn đề, xây dựng các mối quan hệ xã hội bền chặt và cải thiện sức khỏe thể chất.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
            ...
            answer: 'Sơ đồ xương cá, hay còn gọi là sơ đồ Ishikawa, là một công cụ trực quan để phân tích nguyên nhân-kết quả. Nó giúp xác định và phân loại các nguyên nhân tiềm tàng của một vấn đề, thường được nhóm thành các loại chính như Con người, Quy trình, Máy móc, Vật liệu, Môi trường.',
        },
        {
            question: 'Tại sao việc "brainstorm" (động não) lại quan trọng khi tìm giải pháp?',
            answer: 'Brainstorming khuyến khích việc tạo ra một số lượng lớn các ý tưởng mà không phán xét chúng ngay lập tức. Điều này giúp phá vỡ lối mòn tư duy, khám phá các khả năng sáng tạo và tăng cơ hội tìm ra một giải pháp đột phá.',
        },
        {
            question: 'Sự khác biệt giữa giải quyết vấn đề và ra quyết định là gì?',
            answer: 'Giải quyết vấn đề là một quy trình rộng hơn, bao gồm việc xác định vấn đề và tìm ra các giải pháp. Ra quyết định là một bước trong quy trình đó, là hành động lựa chọn một giải pháp tốt nhất từ các phương án đã có.',
        },
        {
            question: 'Ma trận Eisenhower là gì và nó giúp ra quyết định như thế nào?',
            answer: 'Đây là một công cụ quản lý thời gian và ưu tiên công việc. Nó chia các nhiệm vụ thành 4 ô dựa trên hai tiêu chí: Khẩn cấp và Quan trọng. Điều này giúp bạn quyết định nên làm gì ngay, lên lịch làm gì, ủy thác cho ai, hoặc loại bỏ việc gì.',
        },
        {
            question: 'Tại sao cần phải "đánh giá kết quả" sau khi thực hiện giải pháp?',
            answer: 'Việc đánh giá giúp bạn xác định xem giải pháp có thực sự hiệu quả hay không. Nếu vấn đề vẫn còn, bạn có thể cần quay lại các bước trước để phân tích lại hoặc thử một giải pháp khác. Đây là một bước quan trọng để học hỏi và cải tiến.',
        },
        {
            question: 'Làm thế nào để giải quyết mâu thuẫn trong nhóm một cách xây dựng?',
            answer: 'Hãy tập trung vào vấn đề, không phải con người. Lắng nghe quan điểm của tất cả các bên một cách khách quan, tìm kiếm điểm chung và mục tiêu chung, và cùng nhau tìm ra một giải pháp mà tất cả mọi người đều có thể chấp nhận (win-win).',
        },
        {
            question: 'Tư duy phản biện (critical thinking) có vai trò gì trong giải quyết vấn đề?',
            answer: 'Tư duy phản biện là khả năng phân tích thông tin một cách khách quan, đánh giá các lập luận, và xác định các giả định ẩn. Nó là kỹ năng cốt lõi giúp bạn phân tích sâu sắc nguyên nhân của vấn đề và đánh giá hiệu quả của các giải pháp tiềm năng.',
        },
        {
            question: 'Khi nào nên chấp nhận một giải pháp "đủ tốt" thay vì tìm kiếm giải pháp "hoàn hảo"?',
            answer: 'Trong nhiều tình huống thực tế, việc tìm kiếm một giải pháp hoàn hảo có thể tốn quá nhiều thời gian và nguồn lực. Nếu một giải pháp "đủ tốt" có thể giải quyết được vấn đề một cách hiệu quả, ít tốn kém và có thể thực hiện ngay, đó thường là lựa chọn khôn ngoan hơn.',
        },
      ],
    },
  ],
