...
export const psychologyBehavioralScienceModule: ModuleData<PsychologyBehavioralScienceLesson> = {
  ...
  lessons: [
    ...
    },
    {
      ...
      description:
        'Áp dụng các nguyên tắc tâm lý học để tạo ra các sản phẩm số hấp dẫn, dễ sử dụng và có ý nghĩa hơn.',
      duration: '60 phút',
      difficulty: 'Nâng cao',
      objectives: [
