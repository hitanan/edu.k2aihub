...
export const electricVehicleLessons: BaseLessonData[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Là một tính năng trên nhiều xe điện, cho phép người lái tăng tốc và giảm tốc chỉ bằng một bàn đạp ga. Khi nhả chân ga, hệ thống phanh tái tạo sẽ tự động kích hoạt mạnh, làm xe chậm lại đáng kể mà không cần dùng đến bàn đạp phanh. Điều này giúp lái xe thoải mái hơn trong điều kiện giao thông đô thị.',
      },
      {
        question: 'Tại sao xe điện có khả năng tăng tốc nhanh hơn xe xăng?',
        answer:
          'Động cơ điện cung cấp mô-men xoắn cực đại gần như ngay lập tức từ khi đứng yên, không cần chờ đợi vòng tua máy lên cao như động cơ đốt trong. Điều này mang lại cảm giác tăng tốc "dính lưng" rất ấn tượng.',
      },
      {
        question: 'Hệ thống quản lý pin (BMS - Battery Management System) có vai trò gì?',
        answer:
          'BMS là "bộ não" của bộ pin. Nó liên tục theo dõi trạng thái của từng cell pin, cân bằng điện áp, quản lý nhiệt độ, và bảo vệ pin khỏi các tình trạng nguy hiểm như sạc quá đầy hoặc xả quá cạn, đảm bảo pin hoạt động an toàn và có tuổi thọ cao nhất.',
      },
      {
        question: 'Các loại động cơ điện nào thường được sử dụng trên ô tô điện?',
        answer:
          'Hai loại phổ biến nhất là động cơ cảm ứng AC (AC Induction Motor), nổi tiếng với sự bền bỉ và được Tesla sử dụng trong thời gian đầu, và động cơ đồng bộ nam châm vĩnh cửu (Permanent Magnet Synchronous Motor - PMSM), có hiệu suất cao hơn và gọn nhẹ hơn, đang ngày càng phổ biến.',
      },
      {
        question: 'Xe điện có cần hộp số không?',
        answer:
          'Hầu hết xe điện không cần hộp số đa cấp như xe xăng. Động cơ điện có thể hoạt động hiệu quả trên một dải tốc độ rất rộng, do đó chúng thường chỉ sử dụng một hộp số giảm tốc cấp duy nhất để truyền lực đến bánh xe.',
      },
      {
        question: 'Dung lượng pin được đo bằng đơn vị gì?',
        answer:
          'Dung lượng pin xe điện thường được đo bằng kilowatt-giờ (kWh). Con số này cho biết lượng năng lượng mà pin có thể lưu trữ. Dung lượng pin càng lớn (kWh càng cao) thì xe có thể đi được quãng đường càng xa sau mỗi lần sạc đầy.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Pin thể rắn sử dụng chất điện phân dạng rắn thay vì dạng lỏng như pin lithium-ion hiện tại. Chúng hứa hẹn mang lại nhiều ưu điểm vượt trội: mật độ năng lượng cao hơn (giúp xe đi xa hơn), sạc nhanh hơn, an toàn hơn (khó cháy nổ hơn) và tuổi thọ cao hơn. Tuy nhiên, công nghệ này vẫn đang trong giai đoạn nghiên cứu và chưa được thương mại hóa rộng rãi.',
      },
      {
        question: '"Range Anxiety" (Nỗi lo về phạm vi hoạt động) là gì?',
        answer:
          'Đây là nỗi sợ của người lái xe điện rằng pin sẽ hết năng lượng trước khi họ đến được điểm đến hoặc trạm sạc tiếp theo. Nỗi lo này đang giảm dần khi dung lượng pin ngày càng lớn và mạng lưới trạm sạc công cộng ngày càng dày đặc.',
      },
      {
        question: 'Xe điện có thực sự "xanh" hơn xe xăng không, nếu tính cả quá trình sản xuất pin?',
        answer:
          'Câu trả lời là có, trong hầu hết các trường hợp. Mặc dù việc sản xuất pin tiêu tốn năng lượng và tài nguyên, nhưng trong toàn bộ vòng đời, xe điện tạo ra lượng khí thải carbon thấp hơn đáng kể so với xe xăng. Lợi ích về môi trường càng lớn nếu nguồn điện dùng để sạc xe đến từ các nguồn năng lượng tái tạo.',
      },
      {
        question: 'BYD là công ty nào và tại sao họ lại là đối thủ lớn của Tesla?',
        answer:
          'BYD (Build Your Dreams) là một tập đoàn khổng lồ của Trung Quốc, không chỉ sản xuất xe điện mà còn là một trong những nhà sản xuất pin lớn nhất thế giới. Họ có lợi thế lớn về việc tự chủ chuỗi cung ứng và cung cấp các mẫu xe điện với giá cả cạnh tranh ở nhiều phân khúc, giúp họ vượt qua Tesla về doanh số xe điện toàn cầu trong một số quý.',
      },
      {
        question: 'Xu hướng "Software-Defined Vehicle" (Xe được định nghĩa bằng phần mềm) có ý nghĩa gì?',
        answer:
          'Đây là xu hướng mà các tính năng và hiệu suất của xe ngày càng được quyết định bởi phần mềm thay vì phần cứng. Điều này cho phép các nhà sản xuất có thể nâng cấp, sửa lỗi, hoặc thậm chí bán thêm các tính năng mới cho xe thông qua các bản cập nhật phần mềm qua mạng (Over-the-Air updates), tương tự như cách bạn cập nhật điện thoại thông minh.',
      },
      {
        question: 'Thị trường xe điện đã qua sử dụng (second-hand) hiện nay như thế nào?',
        answer:
          'Thị trường xe điện đã qua sử dụng đang phát triển nhưng vẫn còn mới mẻ. Một trong những lo ngại lớn nhất của người mua là tình trạng "sức khỏe" của pin. Nhiều công cụ và dịch vụ đang được phát triển để có thể chẩn đoán và chứng nhận chất lượng pin, giúp tăng tính minh bạch và sự tin tưởng cho thị trường này.',
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Có. Lốp xe điện thường được thiết kế đặc biệt để chịu được trọng lượng nặng hơn của xe (do pin), có lực cản lăn thấp để tối ưu hóa phạm vi hoạt động, và đủ bền để xử lý mô-men xoắn tức thời của động cơ điện. Chúng cũng thường có một lớp bọt bên trong để giảm tiếng ồn vọng vào cabin.',
      },
      {
        question: 'Hệ thống làm mát của xe điện có quan trọng không?',
        answer:
          'Cực kỳ quan trọng. Pin và động cơ điện hoạt động hiệu quả nhất trong một dải nhiệt độ nhất định. Hệ thống quản lý nhiệt (thường bằng chất lỏng) có nhiệm vụ làm mát các bộ phận này khi chúng hoạt động ở cường độ cao và làm ấm chúng khi thời tiết quá lạnh, giúp đảm bảo hiệu suất và tuổi thọ.',
      },
      {
        question: 'Tôi có thể tự thay pin 12V trên xe điện không?',
        answer:
          'Có. Giống như xe xăng, xe điện cũng có một pin phụ 12V để chạy các hệ thống điện áp thấp như đèn, màn hình, radio. Pin này có thể hết và cần được thay thế. Việc thay thế nó tương tự như trên xe xăng và chủ xe có thể tự làm được.',
      },
      {
        question: 'Làm thế nào để tối đa hóa tuổi thọ pin xe điện?',
        answer:
          'Có một số cách để tối đa hóa tuổi thọ pin xe điện: Tránh sạc quá đầy hoặc để pin cạn kiệt hoàn toàn. Sử dụng sạc nhanh DC chỉ khi cần thiết, ưu tiên sạc AC thông thường. Giữ cho xe ở trong khoảng nhiệt độ lý tưởng (không quá nóng hoặc quá lạnh). Thường xuyên kiểm tra và bảo trì hệ thống làm mát của xe.',
      },
      {
        question: 'Có nên để xe điện ở chế độ chờ (standby) lâu ngày không?',
        answer:
          'Không nên. Để xe ở chế độ chờ quá lâu có thể làm giảm tuổi thọ pin do quá trình tự xả và có thể gây ra các vấn đề về phần mềm điều khiển. Nếu không sử dụng xe trong thời gian dài, tốt nhất là nên sạc đầy pin và đỗ xe ở nơi khô ráo, thoáng mát.',
      },
      {
        question: 'Phần mềm trên xe điện có cần được cập nhật không?',
        answer:
          'Có, rất quan trọng. Các bản cập nhật phần mềm qua mạng (Over-the-Air - OTA) không chỉ sửa lỗi mà còn có thể cải thiện hiệu suất, bổ sung tính năng mới, tối ưu hóa việc quản lý pin và thậm chí tăng phạm vi hoạt động của xe. Việc giữ cho phần mềm của xe luôn được cập nhật là rất cần thiết.',
      },
    ],
  },
];
