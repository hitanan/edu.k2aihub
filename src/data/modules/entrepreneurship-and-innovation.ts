  ...
  lessons: [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "Sự kiên trì được rèn luyện qua việc đặt ra các mục tiêu dài hạn và làm việc chăm chỉ để đạt được chúng, ngay cả khi đối mặt với trở ngại. Hãy bắt đầu từ những dự án nhỏ, cam kết hoàn thành chúng, và dần dần tăng độ khó. Việc ăn mừng những chiến thắng nhỏ trên đường đi cũng giúp duy trì động lực."
        },
        {
          question: "Tư duy phát triển (growth mindset) khác gì tư duy cố định (fixed mindset)?",
          answer: "Người có tư duy cố định tin rằng tài năng là bẩm sinh và không thể thay đổi. Họ có xu hướng né tránh thử thách. Ngược lại, người có tư duy phát triển tin rằng họ có thể cải thiện khả năng của mình thông qua nỗ lực. Họ xem thử thách là cơ hội để học hỏi và không sợ thất bại."
        },
        {
          question: "Tại sao một doanh nhân cần có 'thiên kiến hành động' (bias for action)?",
          answer: "Trong một môi trường không chắc chắn như khởi nghiệp, việc chờ đợi để có đủ mọi thông tin là không thể. 'Thiên kiến hành động' có nghĩa là ưu tiên việc thử nghiệm nhanh một ý tưởng để có dữ liệu thực tế, thay vì chỉ ngồi phân tích trên lý thuyết. Hành động tạo ra học hỏi."
        },
        {
          question: "Làm sao để biết một ý tưởng có phải là một 'cơ hội' kinh doanh tốt?",
          answer: "Một cơ hội tốt thường giải quyết một vấn đề 'nhức nhối' (pain point) cho một nhóm khách hàng đủ lớn, và họ sẵn sàng trả tiền để giải quyết vấn đề đó. Cơ hội cũng cần phù hợp với kỹ năng và đam mê của bạn, và có tiềm năng phát triển trong tương lai."
        },
        {
          question: "Em có cần phải biết về tài chính hay marketing để khởi nghiệp không?",
          answer: "Bạn không cần phải là chuyên gia, nhưng việc có kiến thức cơ bản về các lĩnh vực này là rất quan trọng. Quan trọng hơn là khả năng học hỏi nhanh và biết khi nào cần tìm kiếm sự giúp đỡ từ các chuyên gia hoặc người cố vấn (mentor)."
        },
        {
          question: "Vai trò của người cố vấn (mentor) trong khởi nghiệp là gì?",
          answer: "Một người cố vấn tốt có thể cung cấp những lời khuyên quý báu từ kinh nghiệm thực tế của họ, giúp bạn tránh được những sai lầm phổ biến, kết nối bạn với các mối quan hệ quan trọng và đưa ra một góc nhìn khách quan về doanh nghiệp của bạn."
        },
        {
          question: "Làm thế nào để cân bằng giữa việc học ở trường và theo đuổi một dự án khởi nghiệp?",
          answer: "Đây là một thử thách lớn. Quản lý thời gian là chìa khóa. Hãy bắt đầu dự án của bạn ở quy mô nhỏ, tận dụng các kỳ nghỉ hoặc thời gian rảnh. Hãy xem dự án khởi nghiệp như một phần của việc học, nơi bạn áp dụng những kiến thức từ trường lớp vào thực tế. Đừng ngần ngại chia sẻ khó khăn với giáo viên hoặc người cố vấn để nhận được sự hỗ trợ."
        },
        {
          question: "Nỗi sợ bị người khác đánh giá ý tưởng của mình có cản trở em không?",
          answer: "Đây là một nỗi sợ phổ biến. Hãy nhớ rằng, một ý tưởng khi mới ra đời thường trông có vẻ kỳ quặc hoặc không khả thi. Thay vì sợ bị đánh giá, hãy xem mỗi lời góp ý, dù tích cực hay tiêu cực, là một cơ hội để học hỏi và làm cho ý tưởng của bạn tốt hơn. Hãy tìm kiếm những người góp ý xây dựng."
        }
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
            ...
            "answer": "Nó trực quan, dễ hiểu và thúc đẩy sự hợp tác. Cả nhóm có thể cùng nhau làm việc trên một tấm bảng, di chuyển các ghi chú và thảo luận. Nó giúp mọi người có một cái nhìn tổng thể và cùng một ngôn ngữ chung về mô hình kinh doanh, thay vì đọc một tài liệu kế hoạch kinh doanh dài hàng chục trang."
        },
        {
            "question": "Khối nào trong Canvas thường là nơi bắt đầu?",
            "answer": "Thông thường, bạn nên bắt đầu với cặp 'Phân khúc khách hàng' và 'Giải pháp giá trị'. Đây là trái tim của mô hình kinh doanh. Bạn cần xác định rõ bạn đang phục vụ ai và bạn mang lại giá trị gì cho họ trước khi nghĩ đến các yếu tố khác."
        },
        {
            "question": "Làm thế nào để kiểm chứng các giả định trong Business Model Canvas?",
            "answer": "Mỗi khối trong Canvas chứa đựng các giả định cần được kiểm chứng. Ví dụ, để kiểm chứng 'Phân khúc khách hàng', bạn cần ra ngoài và nói chuyện với khách hàng tiềm năng (customer development). Để kiểm chứng 'Dòng doanh thu', bạn có thể thử nghiệm các mức giá khác nhau với một MVP."
        },
        {
            "question": "Sự khác biệt giữa 'Kênh phân phối' (Channels) và 'Quan hệ khách hàng' (Customer Relationships) là gì?",
            "answer": "'Kênh phân phối' là cách bạn đưa giải pháp giá trị đến với khách hàng (ví dụ: website, cửa hàng ứng dụng, cửa hàng vật lý). 'Quan hệ khách hàng' là loại hình mối quan hệ bạn thiết lập với họ (ví dụ: tự phục vụ, hỗ trợ cá nhân, cộng đồng người dùng)."
        },
        {
            "question": "Lean Canvas là gì và nó khác gì Business Model Canvas?",
            "answer": "Lean Canvas là một biến thể của Business Model Canvas, được điều chỉnh đặc biệt cho các startup giai đoạn đầu. Nó thay thế các khối 'Đối tác chính', 'Hoạt động chính', 'Nguồn lực chính' bằng các khối tập trung hơn vào sự không chắc chắn: 'Vấn đề', 'Giải pháp', 'Các chỉ số chính' và 'Lợi thế không công bằng'."
        },
        {
            "question": "Làm thế nào để sử dụng Canvas để phân tích đối thủ cạnh tranh?",
            "answer": "Bạn có thể điền vào một Business Model Canvas cho từng đối thủ cạnh tranh chính của mình. Điều này giúp bạn hiểu rõ cách họ hoạt động, điểm mạnh, điểm yếu của họ là gì, và từ đó tìm ra những cơ hội để làm khác biệt hoặc tốt hơn."
        },
        {
            "question": "Cơ cấu chi phí (Cost Structure) bao gồm những gì?",
            "answer": "Nó bao gồm tất cả các chi phí quan trọng nhất để vận hành mô hình kinh doanh của bạn. Có hai loại chính: chi phí cố định (ví dụ: tiền thuê văn phòng, lương nhân viên) và chi phí biến đổi (ví dụ: chi phí nguyên vật liệu, chi phí quảng cáo trên mỗi lượt nhấp)."
        },
        {
            "question": "Một mô hình kinh doanh có thể có nhiều 'Phân khúc khách hàng' không?",
            "answer": "Có, nhiều doanh nghiệp phục vụ nhiều phân khúc khách hàng khác nhau. Ví dụ, Google phục vụ người dùng tìm kiếm (miễn phí) và các nhà quảng cáo (trả tiền). Điều quan trọng là phải hiểu rõ giải pháp giá trị, kênh phân phối và dòng doanh thu riêng cho từng phân khúc."
        }
      ],
      quizzes: [
        {
