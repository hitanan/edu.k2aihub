...
export const nanotechnologyModule: ModuleData<NanotechnologyLesson> = {
  id: 'nanotechnology',
  ...
  lessons: [
    ...
    },
    {
      ...
      nanotechApplications: ['Hệ thống phân phối thuốc (Drug Delivery)', 'Chẩn đoán hình ảnh phân tử', 'Kỹ thuật mô và y học tái tạo'],
