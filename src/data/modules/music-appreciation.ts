  ...
  lessons: [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Tiết tấu là sự sắp xếp của âm thanh trong thời gian. Nó bao gồm độ dài của các nốt nhạc và khoảng lặng giữa chúng, tạo ra các mẫu hình nhịp điệu (pattern) lặp đi lặp lại, khiến bạn muốn gật gù hay nhún nhảy theo.',
        },
        {
          question: 'Tempo là gì?',
          answer:
            'Tempo là tốc độ của bản nhạc, được đo bằng số phách mỗi phút (BPM - Beats Per Minute). Tempo nhanh tạo cảm giác sôi nổi, khẩn trương, trong khi tempo chậm tạo cảm giác thư thái, buồn bã.',
        },
        {
          question: 'Động lực (dynamics) trong âm nhạc nghĩa là gì?',
          answer:
            'Động lực là độ to nhỏ (âm lượng) của âm nhạc. Các ký hiệu như p (piano - nhỏ) và f (forte - to) được dùng để chỉ dẫn người chơi nhạc thể hiện sắc thái tình cảm, từ thì thầm đến bùng nổ.',
        },
        {
          question: 'Cấu trúc verse-chorus là gì?',
          answer:
            'Đây là cấu trúc phổ biến nhất trong nhạc pop. "Verse" (phiên khúc) là phần lời hát thay đổi để kể chuyện. "Chorus" (điệp khúc) là phần có giai điệu và lời hát lặp lại, chứa đựng thông điệp chính và dễ nhớ nhất của bài hát.',
        },
        {
          question: 'Hợp âm là gì?',
          answer:
            'Hợp âm là sự kết hợp của ba hoặc nhiều nốt nhạc vang lên cùng một lúc. Các chuỗi hợp âm (chord progression) tạo nên phần nền hòa âm cho bài hát, dẫn dắt cảm xúc của người nghe.',
        },
        {
          question: 'Tại sao một bài hát nghe có vẻ "vui" hoặc "buồn"?',
          answer:
            'Điều này thường được quyết định bởi việc sử dụng hợp âm trưởng (major) và thứ (minor). Hợp âm trưởng thường tạo cảm giác vui tươi, lạc quan, trong khi hợp âm thứ thường gợi lên cảm giác buồn, sâu lắng hoặc kịch tính.',
        },
        {
          question: 'Nhịp 4/4 nghĩa là gì?',
          answer:
            'Đây là loại nhịp phổ biến nhất. Số 4 ở trên có nghĩa là có 4 phách trong mỗi ô nhịp. Số 4 ở dưới có nghĩa là mỗi phách tương ứng với một nốt đen. Bạn có thể đếm "1-2-3-4, 1-2-3-4" theo hầu hết các bài nhạc pop, rock hiện nay.',
        },
        {
          question: 'Sự khác biệt giữa cấu trúc và hình thức (form) là gì?',
          answer:
            'Cấu trúc (structure) thường đề cập đến cách sắp xếp các phần trong một bài hát (verse, chorus, bridge). Hình thức (form) là một khái niệm rộng hơn, có thể chỉ các mẫu hình lớn hơn như sonata form trong nhạc cổ điển hay 12-bar blues trong nhạc blues.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Đây là một chuỗi hợp âm (chord progression) gồm 12 ô nhịp, là cấu trúc phổ biến và nền tảng nhất trong nhạc Blues. Hầu hết các bài hát Blues và nhiều bài Rock and Roll đều được xây dựng dựa trên cấu trúc này.',
        },
        {
          question: 'Nốt "blue" (blue note) là gì?',
          answer:
            'Là những nốt nhạc được chơi hoặc hát ở một cao độ hơi khác (thường là thấp hơn một chút) so với cao độ chuẩn. Những nốt này tạo ra âm thanh đặc trưng, có chút "méo mó", u uất của nhạc Blues.',
        },
        {
          question: 'Nhịp điệu "swing" trong nhạc Jazz là gì?',
          answer:
            'Swing là một cảm giác về nhịp điệu, khó có thể định nghĩa chính xác bằng lời. Về cơ bản, nó là cách chơi các nốt móc đơn không đều nhau (nốt đầu dài hơn nốt sau), tạo ra một cảm giác nhún nhảy, lôi cuốn, thôi thúc người nghe phải chuyển động.',
        },
        {
          question: 'Louis Armstrong có đóng góp gì quan trọng cho nhạc Jazz?',
          answer:
            'Louis Armstrong, với biệt danh "Satchmo", là một trong những nhân vật có ảnh hưởng nhất trong lịch sử nhạc Jazz. Ông đã biến Jazz từ một dòng nhạc tập thể thành nghệ thuật của người độc tấu (soloist) và là một bậc thầy về ứng tác.',
        },
        {
          question: 'Big Band là gì?',
          answer:
            'Big Band là một loại dàn nhạc Jazz lớn, phổ biến trong kỷ nguyên Swing (những năm 1930-1940). Nó thường bao gồm các bộ kèn (trumpet, trombone, saxophone) và bộ nhịp điệu (piano, guitar, bass, trống).',
        },
        {
          question: 'Blues đã ảnh hưởng đến Rock and Roll như thế nào?',
          answer:
            'Rock and Roll về cơ bản là nhạc Blues được chơi với nhịp điệu mạnh hơn, tempo nhanh hơn và sử dụng các nhạc cụ điện. Nhiều nghệ sĩ Rock and Roll đầu tiên như Elvis Presley, Chuck Berry đều cover lại các bài hát Blues.',
        },
        {
          question: 'Scat singing là gì?',
          answer:
            'Là một kỹ thuật hát ứng tác trong nhạc Jazz, trong đó ca sĩ sử dụng những âm tiết vô nghĩa (như "doo-be-doo-bop") để hát những giai điệu ngẫu hứng, bắt chước âm thanh của một nhạc cụ. Louis Armstrong là một trong những người tiên phong của kỹ thuật này.',
        },
        {
          question: 'Sự khác biệt giữa Blues và Jazz là gì?',
          answer:
            'Blues thường có cấu trúc đơn giản hơn (ví dụ: 12 ô nhịp) và tập trung vào việc thể hiện cảm xúc qua lời ca và giai điệu. Jazz phức tạp hơn về hòa âm và nhịp điệu, và đặc biệt nhấn mạnh vào sự ứng tác của các nhạc công.',
        },
      ],
      quizzes: [
        {
