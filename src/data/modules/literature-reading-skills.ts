  ...
  lessons: [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Nhân vật trữ tình là người trực tiếp bộc lộ cảm xúc, suy nghĩ trong bài thơ, là "cái tôi" của tác giả hóa thân vào. Đôi khi nhân vật trữ tình xưng "tôi", "anh", "em", nhưng cũng có thể ẩn mình, không xuất hiện trực tiếp.',
        },
        {
          question: 'Phân biệt giọng điệu và nhịp điệu của bài thơ như thế nào?',
          answer:
            'Nhịp điệu liên quan đến cách ngắt nhịp, sự phối hợp thanh bằng - trắc, tạo nên nhạc tính cho thơ. Giọng điệu là thái độ, tình cảm của người nói (nhân vật trữ tình) thể hiện qua thơ, ví dụ: giọng trang trọng, giọng tha thiết, giọng mỉa mai, giọng buồn thương...',
        },
        {
          question: 'Biện pháp tu từ "ẩn dụ" và "hoán dụ" khác nhau ở điểm nào?',
          answer:
            'Ẩn dụ dựa trên sự tương đồng (giống nhau) giữa hai sự vật, ví dụ: "Ngày ngày mặt trời đi qua trên lăng / Thấy một mặt trời trong lăng rất đỏ" (Viễn Phương) - "mặt trời trong lăng" ẩn dụ cho Bác Hồ. Hoán dụ dựa trên sự tương cận (gần gũi, có liên quan) giữa hai sự vật, ví dụ: "Áo nâu liền với áo xanh" - "áo nâu", "áo xanh" hoán dụ cho nông dân và công nhân.',
        },
        {
          question: 'Không gian và thời gian nghệ thuật trong thơ là gì?',
          answer:
            'Là không gian và thời gian được nhà thơ tái tạo, lựa chọn, và tổ chức lại theo ý đồ nghệ thuật, không đơn thuần là không gian, thời gian thực. Ví dụ, không gian trong "Tây Tiến" vừa hùng vĩ, hoang sơ, vừa thơ mộng, lãng mạn.',
        },
        {
          question: 'Làm sao để phân tích hiệu quả của một biện pháp tu từ?',
          answer:
            'Đừng chỉ gọi tên biện pháp đó. Hãy trả lời ba câu hỏi: 1. Biện pháp đó được thể hiện qua từ ngữ, hình ảnh nào? 2. Nó có tác dụng gợi hình, gợi cảm như thế nào (làm cho hình ảnh/câu thơ sinh động, đẹp, ấn tượng ra sao)? 3. Nó góp phần thể hiện nội dung, tư tưởng, tình cảm gì của tác giả?',
        },
        {
          question: 'Thơ tự do khác gì thơ cách luật (thơ Đường)?',
          answer:
            'Thơ cách luật bị ràng buộc chặt chẽ bởi niêm, luật, vần, đối và số câu, số chữ. Thơ tự do không bị giới hạn về số câu, số chữ, cách gieo vần, ngắt nhịp... cho phép tác giả thể hiện cảm xúc một cách linh hoạt, phóng khoáng hơn.',
        },
        {
          question: 'Khi phân tích bài "Tây Tiến", cần chú ý những điểm đặc sắc nào?',
          answer:
            'Cần chú ý đến cảm hứng lãng mạn và bi tráng. Lãng mạn thể hiện ở vẻ đẹp thiên nhiên hùng vĩ, thơ mộng và hình ảnh người lính hào hoa. Bi tráng thể hiện ở sự hy sinh, gian khổ nhưng không hề bi lụy, yếu đuối mà vẫn kiêu dũng, oai hùng.',
        },
        {
          question: 'Trong bài "Sóng", hình tượng "sóng" và "em" có mối quan hệ như thế nào?',
          answer:
            'Hai hình tượng này song hành, lúc tách ra, lúc hòa vào một. "Sóng" là một hình ảnh ẩn dụ để "em" soi vào, tự nhận thức và bộc lộ những khát khao, trăn trở trong tình yêu. Qua "sóng", những trạng thái của tình yêu được cụ thể hóa và trở nên mãnh liệt hơn.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Là dùng lý lẽ và dẫn chứng để chỉ ra sự sai lầm, phi lý của một ý kiến, quan điểm nào đó. Để bác bỏ hiệu quả, cần chỉ ra được điểm yếu trong luận điểm, sự thiếu xác thực của luận cứ hoặc sự phi logic trong lập luận của đối phương.',
        },
        {
          question: 'Làm thế nào để xác định luận điểm chính của một văn bản dài?',
          answer:
            'Luận điểm chính thường được nêu ở đầu văn bản (đoạn mở bài), cuối văn bản (đoạn kết luận), hoặc được lặp lại nhiều lần dưới các hình thức khác nhau. Hãy chú ý đến các câu chủ đề của mỗi đoạn và tiêu đề của văn bản.',
        },
        {
          question: 'Ngụy biện "người rơm" (straw man) là gì?',
          answer:
            'Là lỗi ngụy biện bằng cách bóp méo, xuyên tạc hoặc đơn giản hóa luận điểm của đối phương cho nó trở nên yếu ớt, dễ bị tấn công hơn, sau đó bác bỏ luận điểm đã bị bóp méo đó. Ví dụ: Người A nói "Nên đầu tư thêm cho giáo dục". Người B ngụy biện: "Vậy là anh muốn cắt hết ngân sách quốc phòng à? Thật vô lý!".',
        },
        {
          question: 'Sự khác biệt giữa thao tác "phân tích" và "chứng minh"?',
          answer:
            'Phân tích là chia nhỏ đối tượng thành các yếu tố, bộ phận để đi sâu tìm hiểu (ví dụ: phân tích nhân vật trên các phương diện ngoại hình, nội tâm...). Chứng minh là dùng những dẫn chứng xác thực, đã được thừa nhận để khẳng định một luận điểm là đúng đắn.',
        },
        {
          question: 'Làm sao để đánh giá một dẫn chứng là đáng tin cậy?',
          answer:
            'Một dẫn chứng đáng tin cậy cần phải cụ thể, xác thực, có nguồn gốc rõ ràng và tiêu biểu. Dẫn chứng từ các nghiên cứu khoa học, số liệu thống kê của các tổ chức uy tín, hoặc các sự kiện lịch sử được ghi nhận rộng rãi thường có độ tin cậy cao.',
        },
        {
          question: 'Thao tác lập luận "bình luận" có gì khác với "phân tích"?',
          answer:
            'Phân tích tập trung vào việc làm rõ các khía cạnh của đối tượng một cách khách quan. Bình luận là bước cao hơn, sau khi phân tích, người viết đưa ra những nhận xét, đánh giá, bàn bạc, mở rộng vấn đề theo quan điểm cá nhân của mình.',
        },
        {
          question: 'Tại sao cần phải nhận diện các lỗi ngụy biện?',
          answer:
            'Nhận diện lỗi ngụy biện giúp chúng ta không bị đánh lừa bởi những lập luận có vẻ hợp lý nhưng thực chất lại sai lầm. Nó giúp ta đánh giá thông tin một cách kritis, xây dựng lập luận của bản thân chặt chẽ hơn và giao tiếp hiệu quả hơn.',
        },
        {
          question: 'Làm thế nào để tóm tắt một văn bản nghị luận một cách hiệu quả?',
          answer:
            'Đầu tiên, hãy xác định luận điểm chính và các luận điểm phụ. Sau đó, xác định các luận cứ chính cho mỗi luận điểm. Cuối cùng, viết lại các ý chính đó bằng lời văn của bạn một cách ngắn gọn, mạch lạc, đảm bảo giữ được mối quan hệ logic giữa các ý.',
        },
      ],
      quizzes: [
        {
