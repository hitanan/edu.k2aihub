...
export const programmingRoboticsModule: ModuleData<ProgrammingRoboticsLesson> = {
  ...
  lessons: [
    {
      ...
      description: 'Nắm vững các ngôn ngữ lập trình cơ bản (Python, C++, ROS) và concepts quan trọng trong robotics programming.',
      duration: '180 phút',
      difficulty: 'Cơ bản',
