  ...
  lessons: [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Dây thanh quản của nam giới dài ra và dày lên do tác động của testosterone, khiến giọng nói trở nên trầm hơn. Quá trình này gọi là "vỡ giọng" và có thể diễn ra từ từ hoặc đột ngột.',
        },
        {
          question: 'Nữ giới bắt đầu có kinh nguyệt có phải là dấu hiệu đáng lo không?',
          answer:
            'Không hề. Kinh nguyệt là một dấu hiệu hoàn toàn bình thường, cho thấy cơ thể bạn nữ đang phát triển và có khả năng sinh sản. Chu kỳ kinh nguyệt có thể không đều trong vài năm đầu và đó cũng là điều bình thường.',
        },
        {
          question: 'Tại sao mình lại cao lớn nhanh hơn các bạn khác (hoặc ngược lại)?',
          answer:
            'Mỗi người có một tốc độ phát triển riêng. Thời điểm bắt đầu và tốc độ của tuổi dậy thì có thể khác nhau rất nhiều giữa các cá nhân, phụ thuộc vào di truyền, dinh dưỡng và các yếu tố khác. Đừng so sánh mình với người khác.',
        },
        {
          question: 'Làm gì khi cảm thấy tự ti về những thay đổi của cơ thể?',
          answer:
            'Hãy nhớ rằng mọi người đều trải qua những thay đổi này. Trò chuyện với người lớn mà bạn tin tưởng (cha mẹ, anh chị), tập trung vào những điểm mạnh của bản thân không liên quan đến ngoại hình, và tham gia các hoạt động thể chất để cảm thấy khỏe mạnh và tự tin hơn.',
        },
        {
          question: 'Mồ hôi và mùi cơ thể có phải là vấn đề lớn không?',
          answer:
            'Tuyến mồ hôi hoạt động mạnh hơn ở tuổi dậy thì, gây ra mùi cơ thể. Đây là điều bình thường. Tắm rửa thường xuyên, sử dụng sản phẩm khử mùi, và mặc quần áo thoáng mát, sạch sẽ sẽ giúp bạn kiểm soát vấn đề này.',
        },
        {
          question: 'Có phải tất cả mọi người đều trải qua tuổi dậy thì cùng một lúc không?',
          answer:
            'Không. Tuổi dậy thì có thể bắt đầu sớm nhất là 8 tuổi ở nữ và 9 tuổi ở nam, hoặc muộn hơn nhiều. Phạm vi "bình thường" rất rộng, vì vậy không cần lo lắng nếu bạn phát triển sớm hơn hoặc muộn hơn bạn bè.',
        },
        {
          question: 'Những giấc mơ "ướt" (mộng tinh) ở nam giới có bình thường không?',
          answer:
            'Hoàn toàn bình thường. Mộng tinh là hiện tượng tinh dịch được giải phóng trong khi ngủ, là một dấu hiệu cho thấy hệ sinh sản của nam giới đang hoạt động. Đây là một phần tự nhiên của quá trình trưởng thành.',
        },
        {
          question: 'Làm thế nào để nói chuyện với bố mẹ về những thay đổi của tuổi dậy thì?',
          answer:
            'Có thể sẽ hơi ngượng ngùng, nhưng bố mẹ là nguồn thông tin và hỗ trợ tuyệt vời. Bạn có thể thử bắt đầu bằng cách nói "Con có một vài câu hỏi về tuổi dậy thì..." hoặc viết ra những thắc mắc của mình. Hãy nhớ rằng họ cũng đã từng trải qua giai đoạn này.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Không. Thuốc tránh thai khẩn cấp chỉ nên được dùng trong trường hợp "bất khả kháng" (ví dụ: bao cao su bị rách). Nó có hiệu quả thấp hơn và nhiều tác dụng phụ hơn so với các biện pháp tránh thai thường xuyên. Lạm dụng thuốc có thể ảnh hưởng đến chu kỳ kinh nguyệt.',
        },
        {
          question: 'STIs (bệnh lây truyền qua đường tình dục) có chữa được không?',
          answer:
            'Nhiều STIs do vi khuẩn gây ra (như lậu, giang mai, chlamydia) có thể chữa khỏi hoàn toàn bằng kháng sinh nếu được phát hiện sớm. Tuy nhiên, các STIs do virus gây ra (như HIV, HPV, herpes) thì không thể chữa khỏi hoàn toàn mà chỉ có thể kiểm soát triệu chứng.',
        },
        {
          question: 'Làm thế nào để biết mình có bị nhiễm STI hay không?',
          answer:
            'Nhiều STIs không có triệu chứng rõ ràng, đặc biệt là ở giai đoạn đầu. Cách duy nhất để biết chắc chắn là đi xét nghiệm. Nếu bạn đã có quan hệ tình dục, hãy cân nhắc việc kiểm tra sức khỏe định kỳ.',
        },
        {
          question: 'Tiêm vắc-xin HPV có tác dụng gì?',
          answer:
            'Vắc-xin HPV giúp phòng ngừa virus Human Papillomavirus, nguyên nhân chính gây ra ung thư cổ tử cung ở nữ giới và một số bệnh ung thư khác ở cả hai giới. Vắc-xin được khuyến nghị cho cả nam và nữ, lý tưởng nhất là trước khi bắt đầu có hoạt động tình dục.',
        },
        {
          question: 'Tình dục an toàn không chỉ là về thể chất, đúng không?',
          answer:
            'Đúng vậy. Tình dục an toàn còn bao gồm cả sự an toàn về mặt cảm xúc. Điều này có nghĩa là cả hai người đều cảm thấy được tôn trọng, thoải mái, không bị ép buộc, và có thể giao tiếp cởi mở về mong muốn cũng như giới hạn của mình.',
        },
        {
          question: 'Tại sao giáo dục giới tính lại quan trọng?',
          answer:
            'Giáo dục giới tính toàn diện cung cấp cho bạn kiến thức khoa học để hiểu về cơ thể mình, đưa ra các quyết định có trách nhiệm, xây dựng các mối quan hệ lành mạnh, và bảo vệ sức khỏe của bản thân cũng như bạn tình.',
        },
        {
          question: 'Nếu cảm thấy không sẵn sàng cho quan hệ tình dục, tôi nên làm gì?',
          answer:
            'Hoàn toàn ổn khi cảm thấy chưa sẵn sàng. Quyết định quan hệ tình dục là một quyết định cá nhân quan trọng. Bạn có quyền nói "không" hoặc "chưa phải bây giờ" bất cứ lúc nào mà không cần phải giải thích. Một người bạn tình tôn trọng bạn sẽ chấp nhận quyết định đó.',
        },
        {
          question: 'Thế nào là một mối quan hệ lãng mạn lành mạnh?',
          answer:
            'Một mối quan hệ lành mạnh được xây dựng trên sự tin tưởng, tôn trọng lẫn nhau, giao tiếp cởi mở, và hỗ trợ. Cả hai người đều cảm thấy an toàn, được là chính mình, và có không gian riêng cho cuộc sống cá nhân của họ.',
        },
      ],
      quizzes: [
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Buồn là một cảm xúc bình thường, thường có lý do cụ thể và sẽ qua đi. Trầm cảm là một rối loạn tâm trạng kéo dài (ít nhất 2 tuần), ảnh hưởng tiêu cực đến mọi mặt của cuộc sống (ăn, ngủ, học tập, các mối quan hệ) và thường không có lý do rõ ràng.',
        },
        {
          question: 'Hít thở sâu giúp giảm stress như thế nào?',
          answer:
            'Khi bạn hít thở sâu và chậm, bạn đang kích hoạt hệ thần kinh phó giao cảm, hệ thống "nghỉ ngơi và tiêu hóa" của cơ thể. Điều này giúp làm chậm nhịp tim, giảm huyết áp và gửi tín hiệu đến não bộ rằng bạn đang an toàn, từ đó làm dịu cảm giác căng thẳng.',
        },
        {
          question: 'Tại sao ngủ đủ giấc lại quan trọng với sức khỏe tinh thần?',
          answer:
            'Giấc ngủ là thời gian để não bộ xử lý thông tin, củng cố trí nhớ và điều chỉnh cảm xúc. Thiếu ngủ có thể làm tăng mức độ hormone gây stress, khiến bạn dễ cáu kỉnh, khó tập trung và dễ bị lo âu, trầm cảm hơn.',
        },
        {
          question: 'Mạng xã hội ảnh hưởng đến sức khỏe tinh thần của thanh thiếu niên như thế nào?',
          answer:
            'Mạng xã hội có thể gây ra áp lực phải thể hiện một cuộc sống hoàn hảo, dẫn đến sự so sánh xã hội và cảm giác tự ti. Nó cũng có thể gây nghiện và làm gián đoạn giấc ngủ. Tuy nhiên, nó cũng có thể là nơi để kết nối và tìm kiếm sự hỗ trợ nếu được sử dụng một cách lành mạnh.',
        },
        {
          question: 'Khi nào tôi nên tìm đến một chuyên gia tâm lý?',
          answer:
            'Nếu bạn cảm thấy buồn bã, lo âu hoặc trống rỗng trong một thời gian dài, và những cảm xúc này ảnh hưởng đến việc học, các mối quan hệ hoặc các hoạt động hàng ngày của bạn, đó là lúc nên tìm kiếm sự giúp đỡ chuyên nghiệp. Nói chuyện với chuyên gia không phải là dấu hiệu của sự yếu đuối, mà là một hành động dũng cảm để chăm sóc bản thân.',
        },
        {
          question: 'Viết nhật ký có thực sự giúp ích không?',
          answer:
            'Có. Viết ra những suy nghĩ và cảm xúc của bạn giúp bạn sắp xếp chúng một cách rõ ràng hơn, nhìn nhận vấn đề từ một góc độ khác và giải tỏa những cảm xúc bị dồn nén. Nó giống như việc có một cuộc trò chuyện riêng tư với chính mình.',
        },
        {
          question: 'Tập thể dục có liên quan gì đến sức khỏe tinh thần?',
          answer:
            'Rất liên quan. Khi tập thể dục, cơ thể giải phóng endorphins, được gọi là "hormone hạnh phúc", giúp cải thiện tâm trạng và giảm đau. Vận động cũng giúp giảm mức độ hormone gây stress và cải thiện chất lượng giấc ngủ.',
        },
        {
          question: 'Làm thế nào để xây dựng khả năng chống chịu (resilience) trước khó khăn?',
          answer:
            'Khả năng chống chịu được xây dựng qua thời gian. Hãy tập trung vào việc xây dựng các mối quan hệ hỗ trợ, duy trì một cái nhìn lạc quan nhưng thực tế, học hỏi từ những sai lầm, và chăm sóc sức khỏe thể chất của bạn. Mỗi lần vượt qua một thử thách nhỏ, bạn lại trở nên mạnh mẽ hơn.',
        },
      ],
      quizzes: [
        {
