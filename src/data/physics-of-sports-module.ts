...
export const physicsOfSportsModuleData: ModuleData = {
  ...
  description:
    'Module này biến các khái niệm vật lý trừu tượng thành những bài học trực quan và thú vị thông qua lăng kính của các môn thể thao như bóng đá, bóng rổ, và trượt ván.',
  level: 'Cơ bản',
  duration: '10-12 giờ',
  category: 'Science & Research',
  features: [
    'Học vật lý qua các ví dụ thực tế.',
    'Thí nghiệm ảo tương tác.',
    'Phân tích video chuyển động chậm.',
    'Thử thách thiết kế và kỹ thuật.',
  ],
  icon: '⚽',
  color: 'from-teal-600 to-cyan-600',
  heroImageUrl: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=1200&h=600&fit=crop',
  objectives: [
    'Áp dụng các định luật Newton vào chuyển động trong thể thao.',
    'Hiểu về khí động học và thủy động lực học.',
    'Phân tích năng lượng và động lượng trong các va chạm.',
  ],
  ...
  industryApplications: [
    'Phân tích hiệu suất vận động viên.',
    'Thiết kế dụng cụ thể thao.',
    'Phát triển game mô phỏng thể thao.',
  ],
