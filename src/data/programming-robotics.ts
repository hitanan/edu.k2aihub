...
export const ProgrammingRoboticsLessons: ProgrammingRoboticsLessonData[] = [
  {
    ...
    description:
      'Nắm vững các ngôn ngữ lập trình cơ bản và concepts quan trọng trong robotics programming.',
    duration: '180 phút',
    difficulty: 'Cơ bản',
  ...
  },
  {
    ...
    description:
      'Tìm hiểu mechanical design, electronics integration, và system engineering trong robotics.',
    duration: '200 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        description:
          'Thiết kế và build complete autonomous mobile robot từ scratch',
        difficulty: 'Nâng cao',
        materials: [
        ...
        expectedResults:
          'Fully functional autonomous robot với navigation, obstacle avoidance, và task execution',
        solution:
  ...
  },
  {
    ...
    description:
      'Khám phá cutting-edge robotics applications và future trends.',
    duration: '140 phút',
    difficulty: 'Nâng cao',
    objectives: [
    ...
    exercises: [
      {
        ...
        description:
          'Phát triển coordinated swarm behavior cho multiple robots',
