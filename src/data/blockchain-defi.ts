...
export const blockchainLessons: BlockchainLesson[] = [
  {
    ...
    description: 'Comprehensive understanding về blockchain technology, cryptographic principles, consensus mechanisms, và decentralized systems. Foundation cho all blockchain applications.',
    duration: '200 phút',
  ...
  },
  {
    ...
    description: 'Advanced smart contract development using Solidity, testing frameworks, security best practices, và deployment strategies cho Ethereum và compatible blockchains.',
    duration: '220 phút',
    difficulty: 'Nâng cao',
  ...
  },
  {
    ...
    description: 'Comprehensive DeFi ecosystem understanding: DEXs, lending protocols, yield farming, liquidity mining, và advanced DeFi strategies cho investment và business applications.',
    duration: '190 phút',
    difficulty: 'Nâng cao',
    blockchainType: 'DeFi',
    objectives: [
  ...
  },
  {
    ...
    description: 'Advanced NFT creation, marketplace development, metaverse applications, và cultural preservation using blockchain technology với focus trên Vietnamese digital culture.',
    duration: '180 phút',
    difficulty: 'Trung bình',
  ...
  },
  {
    ...
    description: 'Comprehensive blockchain security practices, regulatory compliance frameworks, audit processes, và risk management cho enterprise blockchain applications.',
    duration: '170 phút',
    difficulty: 'Nâng cao',
