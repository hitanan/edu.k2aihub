  ...
  [
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1569163139394-de4e4f43e4e5?w=800&h=600&fit=crop&auto=format',
      objectives: [
      ...
      exercises: [
        {
          ...
          expectedResults:
            'Comprehensive monsoon analysis với 80%+ accuracy trong seasonal rainfall prediction',
          solution:
        ...
        },
        {
          ...
          expectedResults:
            'Detailed climate impact assessment với actionable recommendations cho urban planning',
          solution:
      ...
      caseStudies: [
        ...
        },
        {
          ...
          problem:
            'Addressing urban heat island effects và extreme temperature events trong rapidly growing metropolis',
          solution:
      ...
      exercises: [
        {
          ...
          description:
            'Build IoT-based air quality monitoring system cho Ho Chi Minh City với real-time data dashboard',
          difficulty: 'Trung bình',
          materials: [
        ...
        },
        {
          ...
          expectedResults:
            'Complete water quality assessment với regulatory compliance documentation',
          solution:
      ...
      exercises: [
        {
          ...
          expectedResults:
            'Accurate deforestation mapping với 90%+ classification accuracy',
          solution:
        ...
        },
        {
          ...
          expectedResults:
            'Comprehensive coastal change assessment với future vulnerability projections',
          solution:
            'Long-term satellite analysis reveals coastal dynamics enabling evidence-based adaptation planning',
        },
      ],
      realWorldApplications: [
    ...
    },
    {
      ...
      exercises: [
        {
          ...
          expectedResults:
            'Air pollution prediction model với MAE <10 μg/m³ cho 24-hour forecasts',
          solution:
        ...
        },
        {
          ...
          description:
            'Use reinforcement learning để optimize protected area management trong Vietnamese national parks',
          difficulty: 'Nâng cao',
          materials: [
          ...
          expectedResults:
            'Optimized conservation strategy improving biodiversity outcomes by 20-30%',
          solution:
            'AI-driven conservation planning maximizes biodiversity protection within resource constraints',
        },
      ],
      realWorldApplications: [
      ...
      sustainabilityMetrics: [
        {
          ...
          description:
            'Quantify CO2 emission reductions through optimized processes',
          measurement: 'Tons CO2 equivalent saved per year',
        },
        {
          name: 'Resource Use Efficiency',
          description:
            'Measure improvement trong water, energy, material usage',
          measurement: 'Percentage reduction trong resource consumption',
        },
        {
          name: 'Biodiversity Impact',
          description:
            'Assess effects trên species diversity và ecosystem health',
      ...
      caseStudies: [
        ...
        },
        {
          ...
          organization:
            'Can Tho University - Mekong Delta Development Institute',
          problem:
            'Optimizing rice production while minimizing environmental impact trong climate-sensitive delta region',
          solution:
            'Applied machine learning cho precision agriculture với environmental constraint optimization',
          impact:
            'Increased crop yields by 18%, reduced water usage by 25%, minimized fertilizer runoff by 35%',
          innovations: [
