...
export const biomedicalEngineeringLessons: BiomedicalEngineeringLesson[] = [
  {
    ...
    description: 'Comprehensive introduction to medical device design principles, từ concept đến clinical implementation. Cover FDA/CE marking requirements, ISO 13485 quality management, và Vietnamese medical device regulations.',
    duration: '180 phút',
    ...
    exercises: [
      {
        ...
        description: 'Conduct comprehensive risk assessment cho blood pressure monitor design using ISO 14971 methodology',
        difficulty: 'Trung bình',
        materials: [
        ...
        solution: 'Systematic approach identifies 15-20 key risks với appropriate mitigation strategies, demonstrating compliance với international standards'
      },
      {
        ...
        solution: 'Comprehensive dossier preparation with proper classification leads to streamlined approval process within 6-12 months'
      }
    ],
    ...
    caseStudies: [
      {
        ...
        problem: 'Developing locally-manufactured medical devices để reduce healthcare costs trong Vietnamese hospitals',
        solution: 'Established comprehensive R&D program với international partnerships, focusing trên diagnostic equipment và patient monitoring systems',
        impact: 'Successfully launched 5 medical devices với 40% cost reduction compared to imported alternatives, serving 50+ Vietnamese hospitals',
        innovations: [
      ...
      },
      {
        ...
        problem: 'Modernizing hospital infrastructure với integrated medical device systems để improve patient care efficiency',
        solution: 'Implemented comprehensive digital health platform integrating medical devices, EMR systems, và AI-powered diagnostics',
        impact: 'Reduced patient wait times by 35%, improved diagnostic accuracy by 28%, enhanced treatment outcomes through data-driven insights',
        innovations: [
  ...
  },
  {
    ...
    description: 'Advanced techniques for processing biological signals và medical images. Cover ECG, EEG, EMG signal analysis, medical image processing algorithms, và AI applications trong diagnostic imaging.',
    duration: '210 phút',
    difficulty: 'Nâng cao',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    ...
    exercises: [
      {
        ...
        solution: 'Comprehensive approach combining advanced signal processing với machine learning achieves clinical-grade performance for automated cardiac monitoring'
      },
      {
        ...
        solution: 'Advanced deep learning approach enables precise tumor boundary detection, supporting clinical decision-making for neurosurgery planning'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        problem: 'Improving diagnostic accuracy và reducing radiologist workload through automated medical image analysis',
        solution: 'Implemented comprehensive AI platform với deep learning models cho chest X-ray, CT scan, và MRI analysis',
        impact: 'Increased diagnostic speed by 60%, improved accuracy by 25%, reduced missed diagnoses by 40% across radiology department',
        innovations: [
      ...
      },
      {
        ...
        problem: 'Implementing advanced cardiac monitoring systems để improve patient outcomes trong intensive care units',
        solution: 'Deployed AI-powered ECG monitoring với real-time arrhythmia detection và predictive analytics for cardiac events',
        impact: 'Reduced cardiac arrest incidents by 35%, improved response time by 50%, enhanced patient survival rates in ICU',
        innovations: [
  ...
  },
  {
    ...
    description: 'Advanced concepts trong tissue engineering, stem cell technology, và regenerative medicine applications. Cover biomaterials, 3D bioprinting, cell culture techniques, và clinical translation challenges.',
    duration: '240 phút',
    difficulty: 'Nâng cao',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    imageUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&h=600&fit=crop&auto=format',
    ...
    exercises: [
      {
        ...
        solution: 'Optimized bioprinting parameters enable creation of viable cardiac tissues với >90% cell viability và measurable contractile function'
      },
      {
        ...
        solution: 'Comprehensive development approach demonstrates therapeutic potential với clear pathway to clinical translation'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        solution: 'Established comprehensive stem cell program including isolation, expansion, và clinical application protocols',
        impact: 'Treated 200+ patients với various conditions, achieved 70% improvement rates trong orthopedic applications',
        innovations: [
      ...
      },
      {
        ...
        solution: 'Developed neural stem cell therapy program với international collaboration và rigorous clinical protocols',
        impact: 'Pioneered first clinical trials trong Vietnam, demonstrated safety và preliminary efficacy trong 30 patients',
        innovations: [
  ...
  },
  {
    ...
    description: 'Comprehensive exploration của medical robotics applications, từ surgical robots đến rehabilitation systems. Cover control systems, haptic feedback, computer vision, và safety considerations trong clinical environments.',
    duration: '195 phút',
    difficulty: 'Nâng cao',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    imageUrl: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=800&h=600&fit=crop&auto=format',
    ...
    exercises: [
      {
        ...
        expectedResults: 'Stable surgical robot control với precise positioning (<1mm accuracy) và realistic force feedback',
        solution: 'Advanced control algorithms với safety redundancy enable precise surgical manipulation với enhanced surgeon capabilities'
      },
      {
        title: 'Computer Vision for Surgical Navigation',
        description: 'Develop real-time computer vision system cho surgical instrument tracking và anatomical registration',
        difficulty: 'Nâng cao',
        materials: [
        ...
        solution: 'Optimized computer vision pipeline enables precise surgical guidance với minimal latency for enhanced surgical precision'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        organization: 'Cho Ray Hospital - Leading Medical Center',
        problem: 'Implementing advanced robotic surgery capabilities để improve patient outcomes và reduce recovery times',
        solution: 'Deployed da Vinci surgical system với comprehensive training program cho surgical teams và patient selection protocols',
        impact: 'Performed 500+ robotic procedures với 30% reduction trong recovery time, 50% decrease trong complications compared to traditional surgery',
        innovations: [
      ...
      },
      {
        ...
        solution: 'Implemented robot-assisted gait training systems và upper limb rehabilitation robots với personalized therapy protocols',
        impact: 'Enhanced recovery rates by 40%, improved patient motivation, reduced therapist workload while maintaining therapy quality',
        innovations: [
