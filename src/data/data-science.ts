...
export const DataScienceLessons: DataScienceLessonData[] = [
    ...
    exercises: [
      {
        ...
        description:
          'Thực hiện dự án phân tích dữ liệu hoàn chỉnh từ A-Z với dataset bán hàng',
        difficulty: 'Cơ bản',
        materials: [
          'Python',
          'pandas',
        ...
        expectedResults:
          'Professional data analysis report với actionable business insights',
        solution:
    ...
    caseStudies: [
      {
        ...
        solution:
          'Machine learning algorithms analyzing viewing patterns, ratings, demographics',
        impact:
          '80% of content watched comes from recommendations, $1B+ annual value',
        innovations: [
  ...
  },
  {
    ...
    description:
      'Học các thuật toán machine learning phổ biến và cách áp dụng trong thực tế.',
    duration: '200 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        description:
          'Xây dựng portfolio các mô hình ML cho different business scenarios',
        difficulty: 'Nâng cao',
        materials: [
          'scikit-learn',
          'XGBoost',
  ...
  },
  {
    ...
    description:
      'Làm việc với dữ liệu lớn sử dụng các công cụ và framework hiện đại.',
    duration: '180 phút',
    difficulty: 'Nâng cao',
    objectives: [
    ...
    exercises: [
      {
        ...
        description:
          'Xây dựng end-to-end big data pipeline với real-time processing',
    ...
    exercises: [
      {
        ...
        description:
          'Tạo executive dashboard tương tác với multiple data sources',
        difficulty: 'Trung bình',
        procedure: [
