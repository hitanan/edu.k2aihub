...
export const aerospaceEngineeringLessons: AerospaceEngineeringLesson[] = [
  {
    ...
    description: 'Comprehensive aircraft design principles, aerodynamic theory, và flight mechanics. Focus trên Vietnamese aviation industry development và opportunities với Vietnam Airlines, Vietjet, và emerging aerospace sector.',
    duration: '210 phút',
    difficulty: 'Nâng cao',
    ...
    exercises: [
      {
        ...
        description: 'Design efficient regional aircraft optimized cho Vietnamese domestic routes considering tropical climate và airport limitations',
        difficulty: 'Nâng cao',
        materials: [
        ...
        expectedResults: 'Complete aircraft design meeting Vietnamese aviation requirements với performance optimization',
        solution: 'Integrated design approach balances efficiency, safety, và operational requirements cho Vietnamese aviation market'
      },
      {
        ...
        solution: 'Comprehensive UAV development addresses specific Vietnamese operational needs với reliable autonomous capabilities'
      }
    ],
    ...
    caseStudies: [
      {
        ...
        problem: 'Optimizing aircraft fleet composition và maintenance schedules để improve operational efficiency trong competitive market',
        solution: 'Implemented advanced aircraft performance analysis và predictive maintenance systems với data-driven decision making',
        impact: 'Reduced maintenance costs by 20%, improved on-time performance by 15%, optimized fuel efficiency across fleet operations',
        innovations: [
      ...
      },
      {
        ...
        problem: 'Developing cost-effective UAV systems cho Vietnamese farmers để monitor crop health và optimize agricultural practices',
        solution: 'Created locally-designed UAV với integrated sensors cho precision agriculture applications trong Vietnamese conditions',
        impact: 'Improved crop yields by 25%, reduced pesticide usage by 30%, provided real-time monitoring cho 10,000+ hectares',
        innovations: [
  ...
  },
  {
    ...
    description: 'Advanced satellite systems design, orbital mechanics, và space communication technology. Explore Vietnamese space program development và satellite applications cho telecommunications và Earth observation.',
    duration: '195 phút',
    difficulty: 'Nâng cao',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    ...
    exercises: [
      {
        ...
        description: 'Design Earth observation satellite optimized cho Vietnamese environmental monitoring và disaster management',
        difficulty: 'Nâng cao',
        materials: [
        ...
        expectedResults: 'Complete satellite design meeting Vietnamese space program objectives với international compliance',
        solution: 'Comprehensive satellite system enables Vietnamese environmental monitoring capabilities với sustainable space operations'
      },
      {
        title: 'Communication Satellite Network for Rural Vietnam',
        description: 'Design communication satellite constellation providing internet access cho remote areas trong Vietnamese mountains và islands',
        difficulty: 'Nâng cao',
        materials: [
        ...
        expectedResults: 'Satellite communication system providing reliable internet access cho underserved Vietnamese regions',
        solution: 'Strategic satellite network design bridges digital divide enabling economic development trong remote Vietnamese areas'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        problem: 'Developing Vietnamese Earth observation capabilities cho environmental monitoring và natural resource management',
        solution: 'Successfully deployed VNREDSat-1 satellite với high-resolution imaging capabilities supporting national development planning',
        impact: 'Provided crucial Earth observation data supporting agriculture, forestry, disaster management, và urban planning across Vietnam',
        innovations: [
      ...
      },
      {
        ...
        problem: 'Improving communication coverage cho Vietnamese fishing fleet và maritime safety trong South China Sea',
        solution: 'Implemented satellite communication systems providing reliable connectivity cho maritime operations',
        impact: 'Enhanced maritime safety, improved fisheries management, strengthened sovereignty monitoring capabilities',
        innovations: [
  ...
  },
  {
    ...
    description: 'Comprehensive space mission design, systems engineering approach, và project management cho space programs. Focus trên Vietnamese space industry development và international collaboration opportunities.',
    duration: '180 phút',
    difficulty: 'Nâng cao',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    ...
    exercises: [
      {
        ...
        description: 'Conduct comprehensive feasibility study cho Vietnamese lunar exploration mission including technical, economic, và strategic analysis',
        difficulty: 'Nâng cao',
        materials: [
        ...
        solution: 'Systematic mission analysis provides roadmap cho Vietnamese lunar exploration capabilities development'
      },
      {
        title: 'Microsatellite Constellation Mission Design',
        description: 'Design microsatellite constellation mission cho Vietnamese IoT connectivity và environmental monitoring',
        difficulty: 'Nâng cao',
        materials: [
        ...
        solution: 'Innovative constellation approach enables Vietnamese IoT connectivity với cost-effective space infrastructure'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        problem: 'Developing comprehensive national space strategy supporting Vietnamese economic development và national security',
        solution: 'Created 20-year space development roadmap với phased capability building và international cooperation',
        impact: 'Established framework cho Vietnamese space industry development, attracted international partnerships, guided policy development',
        innovations: [
      ...
      },
      {
        ...
        problem: 'Establishing regional space cooperation framework enabling shared space capabilities among ASEAN nations',
        solution: 'Developed collaborative space programs including shared Earth observation systems và disaster monitoring',
        impact: 'Created regional space capabilities, reduced individual country costs, enhanced disaster response coordination',
        innovations: [
  ...
  },
  {
    ...
    description: 'Advanced avionics systems design, flight control algorithms, và navigation technology. Cover modern aircraft systems integration, autonomous flight capabilities, và Vietnamese aviation technology development.',
    duration: '165 phút',
    difficulty: 'Nâng cao',
    videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    ...
    exercises: [
      ...
      },
      {
        ...
        solution: 'Advanced autonomous capabilities enable efficient agricultural monitoring với minimal human intervention'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        solution: 'Implemented comprehensive avionics modernization program với glass cockpit upgrades và enhanced navigation systems',
        impact: 'Improved flight safety, reduced pilot workload, enhanced operational efficiency, achieved regulatory compliance',
        innovations: [
      ...
      },
      {
        ...
        problem: 'Developing indigenous UAV capabilities với advanced avionics cho surveillance và reconnaissance missions',
        solution: 'Created modular avionics platform supporting multiple UAV configurations với autonomous flight capabilities',
        impact: 'Established domestic UAV production capability, reduced foreign dependency, enhanced national security capabilities',
        innovations: [
