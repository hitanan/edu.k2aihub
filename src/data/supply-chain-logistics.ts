...
export const supplyChainLogisticsLessons: SupplyChainLogisticsLesson[] = [
  {
    ...
    prerequisites: [
      'Hiểu biết cơ bản về business operations',
      'Familiarity với Excel và data analysis tools'
    ],
    industryFocus: [
    ...
    exercises: [
      {
        ...
        solution: 'Comprehensive analysis including supplier diversification, geographic risk distribution, và contingency planning'
      }
    ],
  ...
  },
  {
    ...
    prerequisites: [
      ...
      'Understanding của inventory management principles'
    ],
    industryFocus: [
    ...
    exercises: [
      {
        ...
        description: 'Solve complex routing problem cho delivery fleet ở Ho Chi Minh City sử dụng optimization software',
        difficulty: 'Nâng cao',
    ...
    caseStudies: [
      {
        ...
        solution: 'Advanced analytics platform với AI-powered forecasting, real-time data integration, collaborative planning',
  ...
  },
  {
    ...
    prerequisites: [
      ...
      'Understanding of import/export basics'
    ],
    industryFocus: [
    ...
    caseStudies: [
      {
        ...
        solution: 'Supply chain restructuring để meet origin requirements, documentation automation, tariff optimization',
