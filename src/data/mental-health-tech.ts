...
export const mentalHealthLessons: MentalHealthLesson[] = [
  {
    ...
    description: 'Hiểu tác động của technology lên mental health. Học cách sử dụng apps, wearables và digital tools để improve wellbeing và manage stress.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Comprehensive digital wellness system với automated monitoring, intervention protocols, và long-term mental health optimization'
      }
    ],
    ...
    caseStudies: [
      {
        ...
        challenge: 'Severe burnout from 70+ hour work weeks, chronic insomnia, anxiety attacks, complete disconnection from physical và social wellness',
        solution: 'Implemented comprehensive digital wellness system: HRV monitoring for stress, meditation app với daily practice, strict digital boundaries after 8 PM, weekly therapy via BetterHelp platform.',
        results: 'Reduced anxiety levels by 60% trong 3 months, improved sleep quality from 4/10 to 8/10, returned to sustainable 45-hour work weeks, developed healthy technology relationship.',
        insights: [
  ...
  },
  {
    ...
    description: 'Explore AI applications trong mental health: chatbot therapy, personalized interventions, predictive analytics. Build AI tools cho mental wellness support.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Production-ready AI mental health chatbot với clinical validation, ethical safeguards, và professional integration capabilities'
      }
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        challenge: 'Overwhelming demand cho counseling services, 3-week wait times, limited 24/7 support, stigma preventing help-seeking behavior',
        solution: 'Deployed AI chatbot integrated với existing counseling services. Provided immediate support, triaged urgent cases, offered coping strategies, và connected students to human counselors when needed.',
        results: 'Reduced counseling wait times to 5 days, 40% increase trong help-seeking behavior, 24/7 crisis support availability, 85% user satisfaction rate, early intervention prevented 60+ crisis escalations.',
        insights: [
