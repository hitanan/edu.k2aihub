...
export const vietnameseCultureLessons: VietnameseCultureLesson[] = [
  {
    ...
    description: 'Học cách số hóa và bảo tồn di sản văn hóa Việt Nam bằng công nghệ hiện đại. Phát triển solutions cho museums, historical sites và cultural institutions.',
  ...
  },
  {
    ...
    description: 'Phát triển tourism technology solutions cho Vietnamese destinations. Học smart tourism, mobile apps và cultural experience platforms.',
