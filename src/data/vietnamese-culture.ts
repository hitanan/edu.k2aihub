    ...
    exercises: [
      {
        ...
        description:
          'Build virtual museum experience cho Vietnamese traditional crafts',
        difficulty: 'Trung bình',
        requirements: [
        ...
        solution:
          'Three.js-based virtual environment với integrated storytelling',
      },
    ],
    ...
    caseStudies: [
      {
        ...
        impact:
          '500% increase in virtual visitors, preserved 10,000+ artifacts',
        innovations: [
    ...
    exercises: [
      {
        ...
        description:
          'Build comprehensive tourism app cho Ha Long Bay experience',
        difficulty: 'Nâng cao',
        requirements: [
        ...
        solution:
          'React Native app với backend integration và local partnerships',
      },
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        solution:
          'Smart tourism platform với crowd management và cultural education',
        impact:
          '30% better visitor distribution, increased local business revenue',
        innovations: [
