...
export const digitalGovLessons: DigitalGovLesson[] = [
  {
    ...
    description: 'Tìm hiểu chiến lược chính phủ điện tử của Việt Nam, các dịch vụ công trực tuyến và smart city initiatives. Học cách phát triển civic tech solutions.',
  ...
  },
  {
    ...
    description: 'Phát triển IoT systems cho smart city applications. Học air quality monitoring, traffic management, và waste management solutions cho Vietnamese cities.',
  ...
  },
  {
    ...
    description: 'Xây dựng platforms để tăng cường sự tham gia của công dân vào quản lý đô thị. Học participatory budgeting, citizen reporting, và community engagement tools.',
