    ...
    exercises: [
      {
        ...
        description:
          'Design user-friendly portal cho Vietnamese citizen services',
        difficulty: 'Trung bình',
        requirements: [
          'UX/UI design skills',
        ...
        expectedOutput:
          'Complete service portal design với user journey mapping',
    ...
    exercises: [
      {
        ...
        description:
          'Build comprehensive air quality monitoring system cho Vietnamese city',
        difficulty: 'Nâng cao',
        requirements: [
          'IoT sensors',
          'Cloud platform',
        ...
        solution:
          'Arduino/ESP32-based sensors với cloud analytics và mobile app',
      },
    ],
    realWorldApplications: [
    ...
    caseStudies: [
      {
        ...
        results:
          '300% increase in citizen feedback, improved policy acceptance',
        insights: [
