...
export const vietnameseBusinessLessons: VietnameseBusinessLesson[] = [
  {
    ...
    description: 'Khám phá startup ecosystem Việt Nam, các quy định pháp lý, funding sources và success strategies. Học cách navigate trong môi trường kinh doanh Việt Nam.',
    ...
    prerequisites: [
      ...
      'Hiểu biết về thị trường Việt Nam',
  ...
  },
  {
    ...
    description: 'Phát triển FinTech solutions cho Vietnamese market. Học regulatory compliance, payment integration, và financial inclusion strategies.',
  ...
  },
  {
    ...
    description: 'Xây dựng e-commerce business strategy cho Vietnamese consumers. Học local marketplace dynamics, logistics, và customer behavior.',
