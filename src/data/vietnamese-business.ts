    ...
    exercises: [
      {
        ...
        description:
          'Complete online business registration process theo quy định Việt Nam',
        difficulty: 'Cơ bản',
        requirements: [
          'Internet access',
          'Basic Vietnamese reading',
        ...
        expectedOutput:
          'Completed business registration form với proper documentation',
    ...
    caseStudies: [
      {
        ...
        solution:
          'Strategic diversification với focus trên Vietnamese user needs',
    ...
    exercises: [
      {
        ...
        description:
          'Integrate multiple Vietnamese payment methods trong e-commerce platform',
        difficulty: 'Trung bình',
        requirements: [
          'VNPay/ZaloPay API',
          'E-commerce platform',
        ...
        solution:
          'Multi-provider payment orchestration với fallback mechanisms',
      },
    ],
    realWorldApplications: [
