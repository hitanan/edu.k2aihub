...
export const aiSeoOptimizationModuleData: ModuleData = {
  ...
  subtitle:
    'Tối ưu hóa thứ hạng website của bạn với sức mạnh của Trí tuệ Nhân tạo',
  description:
  ...
  industryApplications: [
    {
      name: 'E-commerce',
      description:
        'Tự động tạo mô tả sản phẩm và tối ưu hóa trang danh mục để thu hút khách hàng.',
    },
    {
      name: 'Bất động sản',
      description:
        'Nghiên cứu từ khóa địa phương và tạo nội dung blog về thị trường để dẫn đầu khu vực.',
    },
    {
      name: 'Công nghệ (SaaS)',
      description:
        'Phân tích đối thủ và xây dựng chiến lược nội dung chuyên sâu để thu hút người dùng chuyên nghiệp.',
    },
    {
      name: 'Du lịch',
      description:
        'Tạo các bài viết blog hấp dẫn về điểm đến và tối ưu hóa cho các truy vấn tìm kiếm theo mùa.',
    },
  ],
  marketDemand: {
