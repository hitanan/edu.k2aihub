...
export const vietnameseHealthcareLessons: VietnameseHealthcareLesson[] = [
  {
    ...
    description: 'Phát triển hệ thống y tế số phù hợp với infrastructure và regulations của Việt Nam. Học Electronic Health Records, telemedicine platforms và health data management.',
  ...
  },
  {
    ...
    description: 'Phát triển AI medical imaging solutions phù hợp với Vietnamese medical practices. Học computer vision cho radiology, pathology và diagnostic assistance.',
