...
export const TYPING_SPEED_DATA: TypingSpeedGameData = {
  texts: [
    {
      ...
      content: 'Chào mừng bạn đến với trò chơi luyện tập đánh máy. Hãy gõ từng từ một cách chính xác và nhanh chóng.',
      difficulty: 'Cơ bản',
      estimatedWPM: 20,
      category: 'Giới thiệu',
    },
    {
      ...
      content: 'Việt Nam là một đất nước xinh đẹp nằm ở Đông Nam Á. Chúng ta có bờ biển dài và nhiều danh lam thắng cảnh.',
      difficulty: 'Cơ bản',
      estimatedWPM: 25,
      category: 'Địa lý',
    },
  ...
  wordLists: {
    common: [
      'và', 'của', 'có', 'trong', 'một', 'được', 'là', 'để', 'với', 'các',
      'người', 'về', 'đây', 'tôi', 'bạn', 'họ', 'chúng', 'khi', 'nào', 'như'
    ],
    programming: [
    ...
    vietnamese: [
      'xin chào', 'cảm ơn', 'hẹn gặp lại', 'học tập', 'công việc', 'gia đình',
      'bạn bè', 'thành công', 'hạnh phúc', 'sức khỏe', 'tương lai', 'hy vọng'
    ],
    technical: [
      'algorithm', 'database', 'framework', 'interface', 'development',
