...
export const cyberSecurityLessons: CyberSecurityLesson[] = [
  {
    ...
    description: 'Học ethical hacking basics, penetration testing methodologies, vulnerability assessment. Master tools như Kali Linux, Metasploit, Nmap cho security testing.',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Complete penetration testing report với executive summary, technical findings, risk assessment, và remediation roadmap'
      }
    ],
    ...
    resources: [
      {
        ...
        type: 'documentation',
        description: 'Comprehensive guide to Kali Linux tools và penetration testing techniques'
      },
      {
    ...
    caseStudies: [
      {
        ...
        challenge: 'Comprehensive security assessment của core banking infrastructure với minimal business disruption, covering network, applications, và physical security trong 2-week engagement.',
        solution: 'Executed multi-phase penetration test: external reconnaissance, internal network assessment, web application testing, wireless security evaluation, và social engineering simulation. Used advanced evasion techniques to bypass security controls.',
        results: 'Identified 47 vulnerabilities including critical remote code execution, achieved domain administrator access, demonstrated potential $50M+ fraud scenario. Client implemented all recommendations, achieving 95% vulnerability reduction trong 6 months.',
        insights: [
  ...
  },
  {
    ...
    description: 'Master cybersecurity defense strategies, SIEM implementation, threat hunting, incident response procedures. Build comprehensive security operations center capabilities.',
    videoUrl: 'https://www.youtube.com/watch?v=inWWhr5tnEA',
    imageUrl: 'https://images.unsplash.com/photo-1563206767-5b18f218e8de?w=400&h=400&fit=crop',
    difficulty: 'Nâng cao',
    duration: '200 phút',
    ...
    exercises: [
      {
        ...
        expectedOutput: 'Fully operational Security Operations Center với automated threat detection, incident response capabilities, và comprehensive security monitoring'
      }
    ],
    realWorldApplications: [
    ...
    resources: [
      {
        ...
        type: 'documentation',
        description: 'Comprehensive cybersecurity framework for risk management và defense strategies'
      },
      {
        title: 'SANS Incident Response Process',
        url: 'https://www.sans.org/white-papers/901/',
        type: 'documentation',
        description: 'Industry-standard incident response methodologies và best practices'
      }
    ],
    caseStudies: [
      {
        ...
        challenge: 'Transform legacy security operations into modern SOC capability, reducing 10,000+ daily alerts to manageable levels while improving detection accuracy và response times across 50+ global locations.',
        solution: 'Implemented next-generation SIEM với AI/ML analytics, deployed SOAR platform với 200+ automated playbooks, established threat hunting program, và created integrated threat intelligence platform. Reduced analyst workload through 80% automation.',
        results: 'Achieved 65% reduction trong false positives, improved MTTD from 4 hours to 12 minutes, reduced MTTR from 24 hours to 2 hours. Prevented $50M+ trong potential damages through early threat detection. SOC became industry benchmark for operational excellence.',
        insights: [
